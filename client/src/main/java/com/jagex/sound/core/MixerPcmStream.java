...
public final class MixerPcmStream extends PcmStream {
	...
	private void method1342(@OriginalArg(0) MixerListener arg0) {
		arg0.unlink();
		arg0.method780();
		@Pc(9) Node local9 = this.aClass69_44.sentinel.prev;
	...
	@OriginalMember(owner = "runetek4.client!ei", name = "a", descriptor = "(Lclient!qb;)V")
	public final synchronized void addSubStream(@OriginalArg(0) PcmStream arg0) {
		this.aClass69_43.add(arg0);
	}
	...
	@OriginalMember(owner = "runetek4.client!ei", name = "e", descriptor = "()V")
	...
	@OriginalMember(owner = "runetek4.client!ei", name = "c", descriptor = "([III)V")
	...
	private void method1348(@OriginalArg(0) Node arg0, @OriginalArg(1) MixerListener arg1) {
		...
		this.anInt1781 = ((MixerListener) this.aClass69_44.sentinel.prev).anInt905;
	}
}
