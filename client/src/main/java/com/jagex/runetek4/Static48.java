...
public final class Static48 {
	...
	public static Packet method1196() {
		...
		local4.p1b(11);
		local4.p1b(Static113.anInt4609);
		local4.p1b(Static162.aBoolean190 ? 1 : 0);
		...
		local4.p1b(Static139.anInt3451);
		local4.p1b(Static178.highDetailLighting ? 1 : 0);
		local4.p1b(Static220.aBoolean244 ? 1 : 0);
		local4.p1b(Static71.aBoolean107 ? 1 : 0);
		local4.p1b(Static102.anInt2679);
		local4.p1b(Static99.aBoolean143 ? 1 : 0);
		local4.p1b(Static125.anInt3104);
		local4.p1b(Static12.anInt391);
		local4.p1b(Static30.anInt978);
		local4.p2(Static114.anInt5831);
		local4.p2(Static22.anInt729);
		local4.p1b(Static76.method1644());
		local4.p4(Static164.anInt3988);
		local4.p1b(Static214.anInt5581);
		local4.p1b(Static164.aBoolean191 ? 1 : 0);
		local4.p1b(Static33.aBoolean63 ? 1 : 0);
		local4.p1b(Static141.anInt3474);
		local4.p1b(Static127.aBoolean159 ? 1 : 0);
		local4.p1b(Static64.aBoolean111 ? 1 : 0);
		return local4;
	}
