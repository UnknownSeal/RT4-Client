...
public final class Static112 {
	...
	public static void method2297() {
		...
		Font.b12Full.drawString(LocalizedText.CHOOSE_OPTION, local3 + 3, local9 + 14, Static195.anInt4581, -1);
		if (GlRenderer.enabled) {
		...
		for (local203 = 0; local203 < PreciseSleep.menuActionRow; local203++) {
			...
			Font.b12Full.drawString(Static269.method2228(local203), local3 + 3, local219, local418, 0);
		}
