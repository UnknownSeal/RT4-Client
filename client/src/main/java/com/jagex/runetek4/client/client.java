...
import com.jagex.runetek4.CollisionMap;
...
import com.jagex.runetek4.Rasterizer;
...
public final class client extends GameShell {
	...
	protected final void mainRedraw() {
		...
		if ((gameState == 30 || gameState == 10) && (GameShell.canvasReplaceRecommended || com.jagex.runetek4.DisplayMode.aLong89 != 0L && com.jagex.runetek4.DisplayMode.aLong89 < MonotonicTime.currentTimeMillis())) {
			com.jagex.runetek4.DisplayMode.setWindowMode(GameShell.canvasReplaceRecommended, com.jagex.runetek4.DisplayMode.getWindowMode(), Preferences.fullScreenWidth, Preferences.fullScreenHeight);
		}
		@Pc(80) int local80;
		@Pc(84) int local84;
		if (GameShell.fullScreenFrame == null) {
			...
			if (local80 != GameShell.frameWidth || local84 != GameShell.frameHeight) {
				...
				com.jagex.runetek4.DisplayMode.aLong89 = MonotonicTime.currentTimeMillis() + 500L;
			}
		}
		if (GameShell.fullScreenFrame != null && !focus && (gameState == 30 || gameState == 10)) {
			com.jagex.runetek4.DisplayMode.setWindowMode(false, Preferences.favoriteWorlds, -1, -1);
		}
	...
	protected final void mainQuit() {
		...
		if (GameShell.fullScreenFrame != null) {
			com.jagex.runetek4.DisplayMode.exitFullScreen(GameShell.fullScreenFrame, GameShell.signLink);
