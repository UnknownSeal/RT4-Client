										...
										while (true) {
											...
											if (tile.aClass3_Sub5_1 != null) {
												...
												for (frontWallTypes = 0; frontWallTypes < local153.anInt662; frontWallTypes++) {
													...
													if (var25 != null) {
														...
														var25.aClass8_4.draw(var25.anInt1714, Static109.anInt2886, Static121.anInt3038, PreciseSleep.anInt5205, com.jagex.runetek4.cache.def.ItemDefinition.anInt2222, var25.anInt1699 - Static149.eyeX, var25.anInt1706 - Static162.eyeY, var25.anInt1703 - Static217.eyeZ, var25.aLong56, local24, null);
													}
												}
												if (GlRenderer.enabled) {
													GlRenderer.method4159(local33);
											...
											if (tile.underlay == null) {
												...
												if (tile.underlay.anInt4865 != 12345678 || Static158.aBoolean187 && local24 <= Static160.anInt3902) {
													Static132.method2610(tile.underlay, occludeLevel, Static109.anInt2886, Static121.anInt3038, PreciseSleep.anInt5205, com.jagex.runetek4.cache.def.ItemDefinition.anInt2222, tileX, tileZ, false);
												}
											}
											if (tileDrawn) {
												...
												if (local549 != null && (local549.key & 0x80000000L) != 0L) {
													...
													local549.entity.draw(0, Static109.anInt2886, Static121.anInt3038, PreciseSleep.anInt5205, com.jagex.runetek4.cache.def.ItemDefinition.anInt2222, local549.xFine - Static149.eyeX, local549.anInt733 - Static162.eyeY, local549.zFine - Static217.eyeZ, local549.key, local24, null);
													if (GlRenderer.enabled && local549.aBoolean49) {
														GlRenderer.method4159(local33);
													}
												}
											...
											if (decor != null && !Static276.visible(occludeLevel, tileX, tileZ, decor.model.getHeight())) {
												...
												if ((decor.type & frontWallTypes) != 0) {
													...
													decor.model.draw(0, Static109.anInt2886, Static121.anInt3038, PreciseSleep.anInt5205, com.jagex.runetek4.cache.def.ItemDefinition.anInt2222, decor.x + decor.anInt1394 - Static149.eyeX, decor.y - Static162.eyeY, decor.z + decor.anInt1392 - Static217.eyeZ, decor.aLong52, local24, null);
													...
													if (nearestZ < nearestX) {
														...
														decor.model.draw(0, Static109.anInt2886, Static121.anInt3038, PreciseSleep.anInt5205, com.jagex.runetek4.cache.def.ItemDefinition.anInt2222, x + decor.anInt1394, y, z + decor.anInt1392, decor.aLong52, local24, null);
													} else if (decor.aClass8_2 != null) {
														if (GlRenderer.enabled) {
															Static120.method2393(Static149.eyeX, Static162.eyeY, Static217.eyeZ, local24, tileX, tileZ);
														}
														decor.aClass8_2.draw(0, Static109.anInt2886, Static121.anInt3038, PreciseSleep.anInt5205, com.jagex.runetek4.cache.def.ItemDefinition.anInt2222, x, y, z, decor.aLong52, local24, null);
													}
												}
												if (GlRenderer.enabled) {
													GlRenderer.method4159(local33);
											...
											if (tileDrawn) {
												...
												if (groundDecor != null && (groundDecor.key & 0x80000000L) == 0L) {
													...
													groundDecor.entity.draw(0, Static109.anInt2886, Static121.anInt3038, PreciseSleep.anInt5205, com.jagex.runetek4.cache.def.ItemDefinition.anInt2222, groundDecor.xFine - Static149.eyeX, groundDecor.anInt733 - Static162.eyeY, groundDecor.zFine - Static217.eyeZ, groundDecor.key, local24, null);
													if (GlRenderer.enabled && groundDecor.aBoolean49) {
														GlRenderer.method4159(local33);
													}
												}
										...
										try {
											...
											while (direction > 0) {
												...
												if (!Static73.method1599(occludeLevel, local1697.anInt1701, local1697.anInt1713, local1697.anInt1696, local1697.anInt1698, local1697.aClass8_4.getHeight())) {
													...
													local1697.aClass8_4.draw(local1697.anInt1714, Static109.anInt2886, Static121.anInt3038, PreciseSleep.anInt5205, com.jagex.runetek4.cache.def.ItemDefinition.anInt2222, local1697.anInt1699 - Static149.eyeX, local1697.anInt1706 - Static162.eyeY, local1697.anInt1703 - Static217.eyeZ, local1697.aLong56, local24, null);
												}
