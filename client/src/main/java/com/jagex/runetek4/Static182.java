...
public final class Static182 {
	...
	public static void method3359(@OriginalArg(1) boolean arg0, @OriginalArg(2) Font arg1) {
		...
		if (GlRenderer.enabled || arg0) {
			local9 = Static254.canvasHei;
			@Pc(15) int local15 = local9 * 956 / 503;
			Static78.aClass3_Sub2_Sub1_3.method1419((Static48.canvasWid - local15) / 2, 0, local15, local9);
			Static243.aClass36_1.method3336(Static48.canvasWid / 2 - Static243.aClass36_1.anInt4270 / 2, 18);
		}
		arg1.method2875(LocalizedText.GAME0_LOADING, Static48.canvasWid / 2, Static254.canvasHei / 2 - 26, 16777215, -1);
		local9 = Static254.canvasHei / 2 - 18;
		if (GlRenderer.enabled) {
			Static46.method1179(Static48.canvasWid / 2 - 152, local9, 304, 34, 9179409);
			Static46.method1179(Static48.canvasWid / 2 - 151, local9 - -1, 302, 32, 0);
			Static46.method1186(Static48.canvasWid / 2 - 150, local9 + 2, Static199.anInt4670 * 3, 30, 9179409);
			Static46.method1186(Static48.canvasWid / 2 + Static199.anInt4670 * 3 - 150, local9 + 2, 300 - Static199.anInt4670 * 3, 30, 0);
		} else {
			Static129.method2483(Static48.canvasWid / 2 - 152, local9, 304, 34, 9179409);
			Static129.method2483(Static48.canvasWid / 2 - 151, local9 + 1, 302, 32, 0);
			Static129.method2495(Static48.canvasWid / 2 - 150, local9 + 2, Static199.anInt4670 * 3, 30, 9179409);
			Static129.method2495(Static199.anInt4670 * 3 + Static48.canvasWid / 2 - 150, local9 + 2, 300 - Static199.anInt4670 * 3, 30, 0);
		}
		arg1.method2875(Static126.aClass100_602, Static48.canvasWid / 2, Static254.canvasHei / 2 + 4, 16777215, -1);
	}
