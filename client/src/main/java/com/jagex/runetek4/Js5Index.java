...
public final class Js5Index {
	...
	public Js5Index(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		this.crc = Static71.method1442(arg0, arg0.length);
		if (arg1 != this.crc) {
	...
	private void method2293(@OriginalArg(1) byte[] arg0) {
		@Pc(12) Packet local12 = new Packet(Js5.uncompress(arg0));
		...
		@Pc(59) int local59 = -1;
		this.groupIds = new int[this.anInt2902];
		@Pc(66) int local66;
		...
		if (local48 != 0) {
			...
			for (local66 = 0; local66 < this.anInt2902; local66++) {
				this.anIntArray271[this.groupIds[local66]] = local12.g4();
			}
			this.aClass76_1 = new IntHashTable(this.anIntArray271);
		}
		for (local66 = 0; local66 < this.anInt2902; local66++) {
			this.anIntArray268[this.groupIds[local66]] = local12.g4();
		}
		for (local66 = 0; local66 < this.anInt2902; local66++) {
			this.anIntArray273[this.groupIds[local66]] = local12.g4();
		}
		for (local66 = 0; local66 < this.anInt2902; local66++) {
