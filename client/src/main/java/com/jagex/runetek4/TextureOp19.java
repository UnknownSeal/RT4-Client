...
@OriginalClass("runetek4.client!mh")
public final class TextureOp19 extends TextureOp {

	@OriginalMember(owner = "runetek4.client!mh", name = "P", descriptor = "I")
	private int anInt3843 = 0;

	@OriginalMember(owner = "runetek4.client!mh", name = "T", descriptor = "I")
	private int anInt3847 = 12288;

	@OriginalMember(owner = "runetek4.client!mh", name = "bb", descriptor = "I")
	private int anInt3854 = 2048;

	@OriginalMember(owner = "runetek4.client!mh", name = "U", descriptor = "I")
	private int anInt3848 = 0;

	@OriginalMember(owner = "runetek4.client!mh", name = "ib", descriptor = "I")
	private int anInt3860 = 2048;

	@OriginalMember(owner = "runetek4.client!mh", name = "Q", descriptor = "I")
	private int anInt3844 = 4096;

	@OriginalMember(owner = "runetek4.client!mh", name = "kb", descriptor = "I")
	private int anInt3862 = 8192;

	@OriginalMember(owner = "runetek4.client!mh", name = "<init>", descriptor = "()V")
	public TextureOp19() {
		super(0, true);
	}
