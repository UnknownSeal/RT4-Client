...
public final class TextureOp6 extends TextureOp {
	...
	@OriginalMember(owner = "runetek4.client!d", name = "W", descriptor = "[I")
	private int[] anIntArray87;

	@OriginalMember(owner = "runetek4.client!d", name = "Q", descriptor = "I")
	private int anInt1234 = 0;

	@OriginalMember(owner = "runetek4.client!d", name = "P", descriptor = "I")
	private int anInt1233 = 10;

	@OriginalMember(owner = "runetek4.client!d", name = "bb", descriptor = "I")
	...
	@OriginalMember(owner = "runetek4.client!d", name = "e", descriptor = "(I)V")
	@Override
	public final void postDecode() {
		this.method991();
	}

	@OriginalMember(owner = "runetek4.client!d", name = "h", descriptor = "(I)V")
	...
	@OriginalMember(owner = "runetek4.client!d", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	public final void decode(@OriginalArg(1) Packet packet, @OriginalArg(0) int code) {
		if (code == 0) {
			this.anInt1233 = packet.g1();
		} else if (code == 1) {
			this.anInt1240 = packet.g2();
		} else if (code == 2) {
			this.anInt1234 = packet.g1();
		}
	}

	@OriginalMember(owner = "runetek4.client!d", name = "a", descriptor = "(IB)[I")
	@Override
	public final int[] method4626(@OriginalArg(0) int arg0) {
		...
		if (this.aClass121_41.aBoolean221) {
			...
			if (this.anInt1234 == 0) {
				...
				Static289.method2614(local19, 0, Texture.width, local34);
			} else {
