...
public final class Js5GlTextureProvider implements GlTextureProvider {
	...
	@OriginalMember(owner = "runetek4.client!nk", name = "J", descriptor = "I")
	private int anInt4186 = 50;

	@OriginalMember(owner = "runetek4.client!nk", name = "b", descriptor = "Lclient!ve;")
	private final CacheArchive aClass153_72;

	@OriginalMember(owner = "runetek4.client!nk", name = "i", descriptor = "Lclient!ve;")
	private final CacheArchive aClass153_73;

	@OriginalMember(owner = "runetek4.client!nk", name = "P", descriptor = "Lclient!gn;")
	private LruHashTable aClass54_12;

	@OriginalMember(owner = "runetek4.client!nk", name = "G", descriptor = "Lclient!gn;")
	private LruHashTable aClass54_11;

	@OriginalMember(owner = "runetek4.client!nk", name = "Q", descriptor = "[B")
	private final byte[] aByteArray61;

	@OriginalMember(owner = "runetek4.client!nk", name = "l", descriptor = "[B")
	private final byte[] aByteArray60;

	@OriginalMember(owner = "runetek4.client!nk", name = "h", descriptor = "[B")
	private final byte[] aByteArray59;

	@OriginalMember(owner = "runetek4.client!nk", name = "F", descriptor = "[S")
	private final short[] aShortArray59;

	@OriginalMember(owner = "runetek4.client!nk", name = "R", descriptor = "[B")
	private final byte[] aByteArray62;

	@OriginalMember(owner = "runetek4.client!nk", name = "k", descriptor = "[Z")
	private final boolean[] aBooleanArray91;

	@OriginalMember(owner = "runetek4.client!nk", name = "a", descriptor = "[Z")
	private final boolean[] aBooleanArray89;

	@OriginalMember(owner = "runetek4.client!nk", name = "c", descriptor = "[Z")
	private final boolean[] aBooleanArray90;

	@OriginalMember(owner = "runetek4.client!nk", name = "s", descriptor = "[Z")
	private final boolean[] aBooleanArray92;

	@OriginalMember(owner = "runetek4.client!nk", name = "D", descriptor = "[Z")
	...
	public Js5GlTextureProvider(@OriginalArg(0) CacheArchive arg0, @OriginalArg(1) CacheArchive arg1, @OriginalArg(2) CacheArchive arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
	...
	@OriginalMember(owner = "runetek4.client!nk", name = "a", descriptor = "(ZI)V")
	...
	@OriginalMember(owner = "runetek4.client!nk", name = "e", descriptor = "(II)[I")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!nk", name = "b", descriptor = "(IZ)I")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!nk", name = "a", descriptor = "(II)I")
	@Override
	public final int method3229(@OriginalArg(1) int arg0) {
		return this.aByteArray59[arg0] & 0xFF;
	}

	@OriginalMember(owner = "runetek4.client!nk", name = "a", descriptor = "(BI)Z")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!nk", name = "b", descriptor = "(II)Z")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!nk", name = "h", descriptor = "(II)I")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!nk", name = "f", descriptor = "(II)Z")
	@Override
	public final boolean method3236(@OriginalArg(0) int arg0) {
		return this.aBooleanArray90[arg0];
	}

	@OriginalMember(owner = "runetek4.client!nk", name = "a", descriptor = "(IZF)[I")
	@Override
