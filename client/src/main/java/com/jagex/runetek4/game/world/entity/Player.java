...
public final class Player extends PathingEntity {
	...
	public void method1262(@OriginalArg(1) Packet arg0) {
		arg0.pos = 0;
	...
	public void method4546(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) long arg8, @OriginalArg(9) int arg9, @OriginalArg(10) ParticleSystem arg10) {
		...
		if (!this.aBoolean98 && this.anObject5 != null) {
			if (Static83.loopCycle >= this.anInt3375) {
				this.anObject5 = null;
			}
			if (this.anInt3390 <= Static83.loopCycle && this.anInt3375 > Static83.loopCycle) {
				if (this.anObject5 instanceof Loc) {
					local515 = (Model) ((Loc) this.anObject5).method1049();
				} else {
					local515 = (Model) this.anObject5;
				}
				local515.translate(this.anInt3379 - this.x, this.anInt3406 + -this.anInt3424, this.anInt3426 - this.z);
		...
		local515.translate(this.x - this.anInt3379, -this.anInt3406 + this.anInt3424, this.z - this.anInt3426);
	}
	...
	private void drawOnMinimap(@OriginalArg(0) ParticleSystem arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Model arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9, @OriginalArg(11) int arg10, @OriginalArg(12) int arg11, @OriginalArg(13) int arg12, @OriginalArg(14) int arg13) {
		...
		@Pc(46) Model local46 = Static220.method3800(local34, this.z, arg11, this.x, arg2, this.anInt3424);
		if (local46 == null) {
			return;
		}
		if (!GlRenderer.enabled) {
	...
	public void method1265(@OriginalArg(1) int arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) int arg2) {
