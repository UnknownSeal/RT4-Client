...
public abstract class Font extends SecondaryNode {
	...
	private void method2853(@OriginalArg(0) JString arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		for (@Pc(14) int local14 = 0; local14 < local12; local14++) {
			...
			if (local22 == 60) {
				...
				if (local22 == 62 && local6 != -1) {
					@Pc(42) JString local42 = arg0.substring(local14, local6 + 1);
					local6 = -1;
	...
	public final void method2857(@OriginalArg(0) JString arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg0 != null) {
	...
	private void method2861(@OriginalArg(0) JString arg0) {
		try {
