...
public final class TextureOp29SubOp2 extends TextureOp29SubOp {
	...
	public static void method898(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		...
		if (arg4 >= TextureOpRasterizer.anInt5773 && TextureOpRasterizer.anInt2869 >= arg4) {
			local95 = IntUtils.clamp(FluTypeList.anInt5063, arg2 + arg3, TextureOpRasterizer.anInt4164);
			local104 = IntUtils.clamp(FluTypeList.anInt5063, arg3 - arg2, TextureOpRasterizer.anInt4164);
		...
		while (local17 > 0) {
			...
			if (TextureOpRasterizer.anInt5773 <= local104 && TextureOpRasterizer.anInt2869 >= local95) {
				@Pc(213) int local213 = IntUtils.clamp(FluTypeList.anInt5063, local15 + arg3, TextureOpRasterizer.anInt4164);
				@Pc(222) int local222 = IntUtils.clamp(FluTypeList.anInt5063, arg3 - local15, TextureOpRasterizer.anInt4164);
	...
	public static void method1623(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		} else if (arg1 - arg6 >= TextureOpRasterizer.anInt4164 && arg6 + arg1 <= FluTypeList.anInt5063 && TextureOpRasterizer.anInt5773 <= arg2 - arg3 && TextureOpRasterizer.anInt2869 >= arg2 + arg3) {
	...
	public static void method1760(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg1 - arg0 >= TextureOpRasterizer.anInt4164 && FluTypeList.anInt5063 >= arg0 + arg1 && arg3 - arg0 >= TextureOpRasterizer.anInt5773 && TextureOpRasterizer.anInt2869 >= arg0 + arg3) {
	...
	public static void method1843(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3) {
		...
		@Pc(14) int local14 = -1;
		@Pc(22) int local22 = IntUtils.clamp(FluTypeList.anInt5063, arg2 + arg3, TextureOpRasterizer.anInt4164);
		@Pc(30) int local30 = IntUtils.clamp(FluTypeList.anInt5063, arg3 - arg2, TextureOpRasterizer.anInt4164);
		...
		while (local7 < local9) {
			...
			if (local12 > 0) {
				...
				if (local68 >= TextureOpRasterizer.anInt5773 && local58 <= TextureOpRasterizer.anInt2869) {
					local84 = IntUtils.clamp(FluTypeList.anInt5063, arg3 + local7, TextureOpRasterizer.anInt4164);
					local93 = IntUtils.clamp(FluTypeList.anInt5063, arg3 - local7, TextureOpRasterizer.anInt4164);
			...
			if (local68 >= TextureOpRasterizer.anInt5773 && TextureOpRasterizer.anInt2869 >= local58) {
				local84 = IntUtils.clamp(FluTypeList.anInt5063, arg3 + local9, TextureOpRasterizer.anInt4164);
				local93 = IntUtils.clamp(FluTypeList.anInt5063, arg3 - local9, TextureOpRasterizer.anInt4164);
	...
	public static void method2826(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		if (arg4 - arg3 >= TextureOpRasterizer.anInt4164 && FluTypeList.anInt5063 >= arg4 + arg3 && TextureOpRasterizer.anInt5773 <= arg1 - arg3 && TextureOpRasterizer.anInt2869 >= arg3 + arg1) {
	...
	public static void method3163(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4) {
		...
		} else if (TextureOpRasterizer.anInt4164 <= arg2 - arg4 && arg2 + arg4 <= FluTypeList.anInt5063 && arg3 - arg1 >= TextureOpRasterizer.anInt5773 && arg3 + arg1 <= TextureOpRasterizer.anInt2869) {
	...
	public static void method4670(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		...
		if (arg1 >= TextureOpRasterizer.anInt5773 && TextureOpRasterizer.anInt2869 >= arg1) {
			...
			local61 = IntUtils.clamp(FluTypeList.anInt5063, arg5 - arg2, TextureOpRasterizer.anInt4164);
			local69 = IntUtils.clamp(FluTypeList.anInt5063, arg2 + arg5, TextureOpRasterizer.anInt4164);
			local78 = IntUtils.clamp(FluTypeList.anInt5063, arg5 - local18, TextureOpRasterizer.anInt4164);
			local87 = IntUtils.clamp(FluTypeList.anInt5063, arg5 + local18, TextureOpRasterizer.anInt4164);
		...
		while (local23 < local32) {
			...
			if (local35 >= 0) {
				...
				if (TextureOpRasterizer.anInt5773 <= local61 && TextureOpRasterizer.anInt2869 >= local161) {
					if (local32 >= local18) {
						local69 = IntUtils.clamp(FluTypeList.anInt5063, local23 + arg5, TextureOpRasterizer.anInt4164);
						local78 = IntUtils.clamp(FluTypeList.anInt5063, arg5 - local23, TextureOpRasterizer.anInt4164);
						...
						local78 = IntUtils.clamp(FluTypeList.anInt5063, local23 + arg5, TextureOpRasterizer.anInt4164);
						local87 = IntUtils.clamp(FluTypeList.anInt5063, arg5 - local23, TextureOpRasterizer.anInt4164);
						local264 = IntUtils.clamp(FluTypeList.anInt5063, arg5 + local69, TextureOpRasterizer.anInt4164);
						local273 = IntUtils.clamp(FluTypeList.anInt5063, arg5 - local69, TextureOpRasterizer.anInt4164);
						if (TextureOpRasterizer.anInt2869 >= local61) {
			...
			if (TextureOpRasterizer.anInt5773 <= local61 && TextureOpRasterizer.anInt2869 >= local161) {
				...
				if (local69 >= TextureOpRasterizer.anInt4164 && FluTypeList.anInt5063 >= local78) {
					local69 = IntUtils.clamp(FluTypeList.anInt5063, local69, TextureOpRasterizer.anInt4164);
					local78 = IntUtils.clamp(FluTypeList.anInt5063, local78, TextureOpRasterizer.anInt4164);
					if (local23 < local18) {
						local87 = local40 >= local23 ? local40 : anIntArray522[local23];
						local264 = IntUtils.clamp(FluTypeList.anInt5063, local87 + arg5, TextureOpRasterizer.anInt4164);
						local273 = IntUtils.clamp(FluTypeList.anInt5063, arg5 - local87, TextureOpRasterizer.anInt4164);
						if (TextureOpRasterizer.anInt2869 >= local61) {
							local280 = ObjTypeList.anIntArrayArray10[local61];
