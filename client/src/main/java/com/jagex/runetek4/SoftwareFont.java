...
public final class SoftwareFont extends Font {
	...
	protected final void method2855(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(5) int local5 = arg1 + arg2 * Rasterizer.destinationWidth;
		@Pc(9) int local9 = Rasterizer.destinationWidth - arg3;
		@Pc(11) int local11 = 0;
		@Pc(13) int local13 = 0;
		@Pc(20) int local20;
		if (arg2 < Rasterizer.viewportTop) {
			...
			local5 += local20 * Rasterizer.destinationWidth;
		}
		...
		if (arg3 > 0 && arg4 > 0) {
			Static285.method1139(Rasterizer.destinationPixels, this.aByteArrayArray7[arg0], arg5, local13, local5, arg3, arg4, local9, local11, arg6);
		}
	}
