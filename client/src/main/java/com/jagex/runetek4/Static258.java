						...
						if (arg2.objTypes[local171] > 0) {
							...
							if (Static260.anInt5014 == 1 && local267.method510()) {
								...
								if ((Static274.anInt4999 & 0x10) != 0 && (local596 == null || local276.getParam(local596.anInt2667, Static121.anInt3039) != local596.anInt2667)) {
									Static98.method1966(Static246.anInt5393, (long) local276.anInt2354, Static34.method882(new JagString[] { Static78.aClass100_466, Static223.aClass100_947, local276.name}), local171, (short) 3, Static102.aClass100_545, arg2.anInt507);
								}
							} else {
								...
								if (local267.method510()) {
									for (local309 = 4; local309 >= 3; local309--) {
										if (local296 != null && local296[local309] != null) {
											...
											Static98.method1966(-1, (long) local276.anInt2354, Static34.method882(new JagString[] { Static8.aClass100_32, local276.name}), local171, local334, local296[local309], arg2.anInt507);
										}
									}
								}
								if (local267.method507()) {
									Static98.method1966(Static169.anInt4075, (long) local276.anInt2354, Static34.method882(new JagString[] { Static8.aClass100_32, local276.name}), local171, (short) 22, LocalizedText.USE, arg2.anInt507);
								}
								...
								Static98.method1966(Static225.anInt5073, (long) local276.anInt2354, Static34.method882(new JagString[] { Static8.aClass100_32, local276.name}), local171, (short) 1006, LocalizedText.EXAMINE, arg2.anInt507);
							}
						}
					}
					local171++;
