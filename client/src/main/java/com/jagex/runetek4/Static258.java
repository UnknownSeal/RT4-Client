...
public final class Static258 {
	...
	public static void method4418(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Component arg2) {
		if (arg2.buttonType == 1) {
			Static98.addActionRow(-1, 0L, JString.EMPTY, 0, (short) 8, arg2.option, arg2.id);
		}
		@Pc(47) JString local47;
		if (arg2.buttonType == 2 && !MiniMenu.aBoolean302) {
			local47 = Static97.method1963(arg2);
			if (local47 != null) {
				Static98.addActionRow(-1, 0L, JString.concatenate(new JString[] { Static42.GREEN, arg2.optionSuffix}), -1, (short) 32, local47, arg2.id);
			}
		}
		if (arg2.buttonType == 3) {
			Static98.addActionRow(-1, 0L, JString.EMPTY, 0, (short) 28, LocalizedText.CLOSE, arg2.id);
		}
		if (arg2.buttonType == 4) {
			Static98.addActionRow(-1, 0L, JString.EMPTY, 0, (short) 59, arg2.option, arg2.id);
		}
		if (arg2.buttonType == 5) {
			Static98.addActionRow(-1, 0L, JString.EMPTY, 0, (short) 51, arg2.option, arg2.id);
		}
		if (arg2.buttonType == 6 && ClientScriptRunner.aClass13_10 == null) {
			Static98.addActionRow(-1, 0L, JString.EMPTY, -1, (short) 41, arg2.option, arg2.id);
		}
		@Pc(173) int local173;
		@Pc(171) int local171;
		if (arg2.type == 2) {
					...
					if (arg1 >= local195 && local202 <= arg0 && local195 + 32 > arg1 && local202 + 32 > arg0) {
						...
						if (arg2.invSlotObjId[local171] > 0) {
							...
							if (MiniMenu.anInt5014 == 1 && local267.method510()) {
								if (FluTypeList.anInt5062 != arg2.id || Static185.anInt4370 != local171) {
									Static98.addActionRow(-1, (long) local276.anInt2354, JString.concatenate(new JString[] { Static34.aClass100_203, Static223.aClass100_947, local276.name}), local171, (short) 40, LocalizedText.USE, arg2.id);
								}
								...
								if ((Static274.anInt4999 & 0x10) != 0 && (local596 == null || local276.getParam(local596.anInt2667, Static121.anInt3039) != local596.anInt2667)) {
									Static98.addActionRow(Static246.anInt5393, (long) local276.anInt2354, JString.concatenate(new JString[] { Static78.aClass100_466, Static223.aClass100_947, local276.name}), local171, (short) 3, Static102.aClass100_545, arg2.id);
								}
							} else {
								...
								if (local267.method510()) {
									for (local309 = 4; local309 >= 3; local309--) {
										if (local296 != null && local296[local309] != null) {
											...
											Static98.addActionRow(-1, (long) local276.anInt2354, JString.concatenate(new JString[] { Static8.aClass100_32, local276.name}), local171, local334, local296[local309], arg2.id);
										}
									}
								}
								if (local267.method507()) {
									Static98.addActionRow(Static169.anInt4075, (long) local276.anInt2354, JString.concatenate(new JString[] { Static8.aClass100_32, local276.name}), local171, (short) 22, LocalizedText.USE, arg2.id);
								}
								...
								Static98.addActionRow(Static225.anInt5073, (long) local276.anInt2354, JString.concatenate(new JString[] { Static8.aClass100_32, local276.name}), local171, (short) 1006, LocalizedText.EXAMINE, arg2.id);
							}
						}
					}
					local171++;
		...
		if (!MiniMenu.aBoolean302) {
			for (local171 = 9; local171 >= 5; local171--) {
				...
				if (local765 != null) {
					Static98.addActionRow(Static8.method118(local171, arg2), (long) (local171 + 1), arg2.optionBase, arg2.createdComponentId, (short) 1003, local765, arg2.id);
				}
			}
			local47 = Static97.method1963(arg2);
			if (local47 != null) {
				Static98.addActionRow(-1, 0L, arg2.optionBase, arg2.createdComponentId, (short) 32, local47, arg2.id);
			}
			for (local173 = 4; local173 >= 0; local173--) {
				@Pc(828) JString local828 = Static205.method3677(arg2, local173);
				if (local828 != null) {
					Static98.addActionRow(Static8.method118(local173, arg2), (long) (local173 + 1), arg2.optionBase, arg2.createdComponentId, (short) 9, local828, arg2.id);
				}
			}
			if (InterfaceList.getServerActiveProperties(arg2).method506()) {
				Static98.addActionRow(-1, 0L, JString.EMPTY, arg2.createdComponentId, (short) 41, LocalizedText.CONTINUE, arg2.id);
			}
		} else if (InterfaceList.getServerActiveProperties(arg2).method508() && (Static274.anInt4999 & 0x20) != 0) {
			Static98.addActionRow(Static246.anInt5393, 0L, JString.concatenate(new JString[] { Static78.aClass100_466, Static201.aClass100_408, arg2.optionBase}), arg2.createdComponentId, (short) 12, Static102.aClass100_545, arg2.id);
		}
	}
