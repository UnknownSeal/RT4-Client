...
public final class Static258 {
	...
	public static void method4418(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Component arg2) {
		...
		if (arg2.anInt530 == 2 && !Static241.aBoolean302) {
			...
			if (local47 != null) {
				Static98.method1966(-1, 0L, Static34.method882(new JString[] { Static42.GREEN, arg2.aClass100_85 }), -1, (short) 32, local47, arg2.anInt507);
			}
		}
		if (arg2.anInt530 == 3) {
						...
						if (arg2.invSlotObjId[local171] > 0) {
							...
							if (Static260.anInt5014 == 1 && local267.method510()) {
								if (Static224.anInt5062 != arg2.anInt507 || Static185.anInt4370 != local171) {
									Static98.method1966(-1, (long) local276.anInt2354, Static34.method882(new JString[] { Static34.aClass100_203, Static223.aClass100_947, local276.name}), local171, (short) 40, LocalizedText.USE, arg2.anInt507);
								}
								...
								if ((Static274.anInt4999 & 0x10) != 0 && (local596 == null || local276.getParam(local596.anInt2667, Static121.anInt3039) != local596.anInt2667)) {
									Static98.method1966(Static246.anInt5393, (long) local276.anInt2354, Static34.method882(new JString[] { Static78.aClass100_466, Static223.aClass100_947, local276.name}), local171, (short) 3, Static102.aClass100_545, arg2.anInt507);
								}
							} else {
								...
								if (local267.method510()) {
									for (local309 = 4; local309 >= 3; local309--) {
										if (local296 != null && local296[local309] != null) {
											...
											Static98.method1966(-1, (long) local276.anInt2354, Static34.method882(new JString[] { Static8.aClass100_32, local276.name}), local171, local334, local296[local309], arg2.anInt507);
										}
									}
								}
								if (local267.method507()) {
									Static98.method1966(Static169.anInt4075, (long) local276.anInt2354, Static34.method882(new JString[] { Static8.aClass100_32, local276.name}), local171, (short) 22, LocalizedText.USE, arg2.anInt507);
								}
								...
								Static98.method1966(Static225.anInt5073, (long) local276.anInt2354, Static34.method882(new JString[] { Static8.aClass100_32, local276.name}), local171, (short) 1006, LocalizedText.EXAMINE, arg2.anInt507);
							}
						}
					}
					local171++;
		...
		if (!Static241.aBoolean302) {
			...
			Static98.method1966(Static246.anInt5393, 0L, Static34.method882(new JString[] { Static78.aClass100_466, Static201.aClass100_408, arg2.aClass100_88 }), arg2.componentId, (short) 12, Static102.aClass100_545, arg2.anInt507);
		}
	}
