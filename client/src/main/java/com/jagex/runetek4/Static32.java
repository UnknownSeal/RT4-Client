...
public final class Static32 {
	...
	public static void method865(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) PlayerEntity arg2, @OriginalArg(4) int[] arg3) {
				...
				if ((local24 & 0x1) != 0) {
					if (local20 == -1) {
						...
						if (local76 != null) {
							...
							} else if (local68.priority >= Static36.method941(local76.anInt5396).priority) {
								local76 = arg2.aClass147Array3[local30] = null;
							}
						}
						if (local76 == null) {
