...
@OriginalClass("runetek4.client!te")
public final class MidiNoteStream extends PcmStream {
	...
	@OriginalMember(owner = "runetek4.client!te", name = "E", descriptor = "Lclient!va;")
	private final MidiPcmStream parent;

	@OriginalMember(owner = "runetek4.client!te", name = "<init>", descriptor = "(Lclient!va;)V")
	public MidiNoteStream(@OriginalArg(0) MidiPcmStream parent) {
		this.parent = parent;
	}

	@OriginalMember(owner = "runetek4.client!te", name = "d", descriptor = "()Lclient!qb;")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!te", name = "b", descriptor = "()Lclient!qb;")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!te", name = "a", descriptor = "(Lclient!mf;II)V")
		...
		if ((this.parent.channelFlags[instrument.channel] & 0x4) != 0 && instrument.anInt3767 < 0) {
			...
			if (len >= local37) {
				if (this.parent.anIntArray509[instrument.channel] == 0) {
					instrument.stream = SoundPcmStream.create(instrument.sound, instrument.stream.method405(), instrument.stream.getVolume(), instrument.stream.method418());
				} else {
					instrument.stream = SoundPcmStream.create(instrument.sound, instrument.stream.method405(), 0, instrument.stream.method418());
	...
	@OriginalMember(owner = "runetek4.client!te", name = "a", descriptor = "()I")
	@Override
	public final int method4404() {
		return 0;
	}

	@OriginalMember(owner = "runetek4.client!te", name = "c", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!te", name = "b", descriptor = "([III)V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!te", name = "a", descriptor = "([ILclient!mf;IIIB)V")
		...
		if ((this.parent.channelFlags[arg1.channel] & 0x4) != 0 && arg1.anInt3767 < 0) {
			...
			while (true) {
				...
				if (this.parent.anIntArray509[arg1.channel] == 0) {
					arg1.stream = SoundPcmStream.create(arg1.sound, local58.method405(), local58.getVolume(), local58.method418());
				} else {
					arg1.stream = SoundPcmStream.create(arg1.sound, local58.method405(), 0, local58.method418());
