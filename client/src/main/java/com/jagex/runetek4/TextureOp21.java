...
@OriginalClass("runetek4.client!nm")
public final class TextureOp21 extends TextureOp {

	@OriginalMember(owner = "runetek4.client!nm", name = "V", descriptor = "I")
	private int anInt4221 = 1;

	@OriginalMember(owner = "runetek4.client!nm", name = "Z", descriptor = "I")
	private int anInt4223 = 1;

	@OriginalMember(owner = "runetek4.client!nm", name = "<init>", descriptor = "()V")
	public TextureOp21() {
		super(1, false);
	}
	...
	public final int[][] getColorOutput(@OriginalArg(1) int arg0) {
		@Pc(13) int[][] local13 = this.clearImageCache.get(arg0);
	...
	@OriginalMember(owner = "runetek4.client!nm", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	public final void decode(@OriginalArg(1) Packet packet, @OriginalArg(0) int code) {
		if (code == 0) {
			this.anInt4221 = packet.g1();
		} else if (code == 1) {
