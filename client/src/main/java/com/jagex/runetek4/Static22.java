...
public final class Static22 {
	...
	@OriginalMember(owner = "runetek4.client!bl", name = "P", descriptor = "I")
	public static int js5ConnectDelay = 0;

	@OriginalMember(owner = "runetek4.client!bl", name = "Q", descriptor = "I")
	public static int anInt723 = 0;

	@OriginalMember(owner = "runetek4.client!bl", name = "T", descriptor = "I")
	public static int anInt726 = 0;

	@OriginalMember(owner = "runetek4.client!bl", name = "W", descriptor = "I")
	public static int anInt729 = 0;

	@OriginalMember(owner = "runetek4.client!bl", name = "X", descriptor = "I")
	public static int anInt730 = -1;

	@OriginalMember(owner = "runetek4.client!bl", name = "a", descriptor = "(IIIIIIII)V")
