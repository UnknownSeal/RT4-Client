...
public final class Static244 {
	...
	public static void method4222(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		@Pc(17) int local17 = IntUtils.clamp(Static106.anInt2869, arg2, Static267.anInt5773);
		@Pc(23) int local23 = IntUtils.clamp(FloorUnderlayTypeList.anInt5063, arg6, Static172.anInt4164);
		@Pc(29) int local29 = IntUtils.clamp(FloorUnderlayTypeList.anInt5063, arg0, Static172.anInt4164);
		@Pc(37) int local37 = IntUtils.clamp(Static106.anInt2869, arg3 + arg5, Static267.anInt5773);
		@Pc(46) int local46 = IntUtils.clamp(Static106.anInt2869, arg2 - arg3, Static267.anInt5773);
		@Pc(48) int local48;
		...
		@Pc(94) int local94 = IntUtils.clamp(FloorUnderlayTypeList.anInt5063, arg3 + arg6, Static172.anInt4164);
		@Pc(103) int local103 = IntUtils.clamp(FloorUnderlayTypeList.anInt5063, arg0 - arg3, Static172.anInt4164);
