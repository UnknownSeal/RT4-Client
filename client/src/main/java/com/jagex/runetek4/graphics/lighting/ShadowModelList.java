...
public class ShadowModelList {
    ...
    public static Model method1043(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) SeqType arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) Model arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12) {
        ...
        if (local386 == null) {
            local33 = local33.copy(true, true, true);
            local33.resize((local115 - local384) / 2, 128, (local130 - local126) / 2);
            local33.translate((local384 + local115) / 2, 0, (local126 + local130) / 2);
        } else {
            local33 = local33.copy(!local386.isAlphaTransformed(arg10), !local386.isColorTransformed(arg10), true);
            local33.resize((local115 - local384) / 2, 128, (local130 - local126) / 2);
            local33.translate((local384 + local115) / 2, 0, (local126 + local130) / 2);
        ...
        if (GlRenderer.enabled) {
            ...
            if (SceneGraph.getTileHeight(Player.currentLevel, arg3 + local384, local126 + arg5) != arg11 || SceneGraph.getTileHeight(Player.currentLevel, local115 + arg3, arg5 - -local130) != arg11) {
                for (local162 = 0; local162 < local650.vertexCount; local162++) {
                    local650.vertexY[local162] += SceneGraph.getTileHeight(Player.currentLevel, local650.vertexX[local162] + arg3, arg5 + local650.vertexZ[local162]) - arg11;
                }
            ...
            if (SceneGraph.getTileHeight(Player.currentLevel, arg3 + local384, arg5 - -local126) != arg11 || arg11 != SceneGraph.getTileHeight(Player.currentLevel, arg3 + local115, arg5 - -local130)) {
                for (local162 = 0; local162 < local574.vertexCount; local162++) {
                    local574.vertexY[local162] += SceneGraph.getTileHeight(Player.currentLevel, arg3 + local574.vertexX[local162], arg5 + local574.vertexZ[local162]) - arg11;
                }
