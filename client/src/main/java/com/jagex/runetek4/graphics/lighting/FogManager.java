package com.jagex.runetek4.graphics.lighting;
...
public class FogManager {
    ...
    @OriginalMember(owner = "runetek4.client!mk", name = "h", descriptor = "[F")
    ...
    static final float[] light1Position = new float[4];
    @OriginalMember(owner = "client!mk", name = "e", descriptor = "I")
    public static int defaulFogColorRgb = 13156520;
    @OriginalMember(owner = "runetek4.client!mk", name = "c", descriptor = "I")
    ...
    static float lightModelAmbient;
    @OriginalMember(owner = "client!mk", name = "f", descriptor = "F")
    static float light0Diffuse = -1.0F;
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "I")
    static int lightColor = -1;
    @OriginalMember(owner = "runetek4.client!mk", name = "g", descriptor = "F")
    static float light1Diffuse = -1.0F;
    @OriginalMember(owner = "runetek4.client!mk", name = "l", descriptor = "I")
    static int fogOffset = -1;
    @OriginalMember(owner = "runetek4.client!mk", name = "m", descriptor = "I")
    static int fogColorRGB = -1;
    ...
    @OriginalMember(owner = "runetek4.client!mk", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "runetek4.client!mk", name = "a", descriptor = "(II)V")
    public static void setFogParams(@OriginalArg(0) int color, @OriginalArg(1) int offset) {
        ...
        @Pc(65) int fogStart = 3072 - offset;
        if (fogStart < 50) {
            fogStart = 50;
        }
        gl.glFogf(GL2.GL_FOG_START, (float) fogStart);
        gl.glFogf(GL2.GL_FOG_END, (float) 3328);
        gl.glFogfv(GL2.GL_FOG_COLOR, fogColor, 0);
    }

    @OriginalMember(owner = "runetek4.client!mk", name = "a", descriptor = "(FFF)V")
