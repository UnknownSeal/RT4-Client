...
public class LightingManager {
    ...
    static final float[] aFloatArray17 = new float[] { 0.0F, 0.0F, 0.0F, 1.0F };
    ...
    @OriginalMember(owner = "runetek4.client!jf", name = "a", descriptor = "(ILclient!gi;III)V")
    static void method2403(@OriginalArg(0) int arg0, @OriginalArg(1) Light arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
    ...
    public static void method2402(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Tile[][][] arg2) {
        ...
        label71: for (@Pc(56) int local56 = 0; local56 < lightCount; local56++) {
            ...
            if (local63.aLightBuffer_1 != null) {
                @Pc(76) int local76 = 0;
