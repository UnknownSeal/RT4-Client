...
import com.jagex.runetek4.graphics.textureops.TextureOpPerlinNoise;
...
public final class LiquidMaterialRenderer implements MaterialRenderer {
	...
	@OriginalMember(owner = "runetek4.client!rd", name = "d", descriptor = "[F")
	public static final float[] aFloatArray24 = new float[4];

	@OriginalMember(owner = "runetek4.client!rd", name = "a", descriptor = "I")
	private int anInt4829 = -1;

	@OriginalMember(owner = "runetek4.client!rd", name = "e", descriptor = "I")
	private int anInt4831 = -1;

	@OriginalMember(owner = "runetek4.client!rd", name = "c", descriptor = "I")
	private int anInt4830;

	@OriginalMember(owner = "runetek4.client!rd", name = "b", descriptor = "Ljava/nio/FloatBuffer;")
	private FloatBuffer aFloatBuffer1;

	@OriginalMember(owner = "runetek4.client!rd", name = "<init>", descriptor = "()V")
	...
	@OriginalMember(owner = "runetek4.client!rd", name = "a", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!rd", name = "b", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!rd", name = "e", descriptor = "()V")
	...
	@OriginalMember(owner = "runetek4.client!rd", name = "f", descriptor = "()V")
	...
	@OriginalMember(owner = "runetek4.client!rd", name = "a", descriptor = "(I)V")
	@Override
