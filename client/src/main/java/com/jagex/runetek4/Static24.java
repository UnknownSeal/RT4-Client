...
public final class Static24 {
	...
	@OriginalMember(owner = "runetek4.client!bn", name = "N", descriptor = "Lclient!be;")
	public static Component component;

	@OriginalMember(owner = "runetek4.client!bn", name = "O", descriptor = "I")
	public static int anInt761;

	@OriginalMember(owner = "runetek4.client!bn", name = "V", descriptor = "I")
	public static int anInt766 = 0;

	@OriginalMember(owner = "runetek4.client!bn", name = "eb", descriptor = "I")
	public static int anInt773 = 0;

	@OriginalMember(owner = "runetek4.client!bn", name = "c", descriptor = "(II)V")
	public static void method666() {
		Static232.aClass99_30.method3102(5);
	}

	@OriginalMember(owner = "runetek4.client!bn", name = "a", descriptor = "(III)I")
	...
	@OriginalMember(owner = "runetek4.client!bn", name = "a", descriptor = "(BZLclient!na;)V")
	...
	@OriginalMember(owner = "runetek4.client!bn", name = "a", descriptor = "(IIB)I")
	...
	@OriginalMember(owner = "runetek4.client!bn", name = "d", descriptor = "(II)Z")
