...
@OriginalClass("runetek4.client!hk")
public final class TextureOpHslAdjust extends TextureOp {

	@OriginalMember(owner = "runetek4.client!hk", name = "Q", descriptor = "I")
	private int anInt2543;

	@OriginalMember(owner = "runetek4.client!hk", name = "Z", descriptor = "I")
	private int anInt2551;

	@OriginalMember(owner = "runetek4.client!hk", name = "cb", descriptor = "I")
	private int anInt2553;

	@OriginalMember(owner = "runetek4.client!hk", name = "gb", descriptor = "I")
	private int anInt2554;

	@OriginalMember(owner = "runetek4.client!hk", name = "ib", descriptor = "I")
	private int anInt2556;

	@OriginalMember(owner = "runetek4.client!hk", name = "jb", descriptor = "I")
	private int anInt2557;

	@OriginalMember(owner = "runetek4.client!hk", name = "T", descriptor = "I")
	private int anInt2546 = 0;

	@OriginalMember(owner = "runetek4.client!hk", name = "U", descriptor = "I")
	private int anInt2547 = 0;

	@OriginalMember(owner = "runetek4.client!hk", name = "X", descriptor = "I")
	private int anInt2549 = 0;

	@OriginalMember(owner = "runetek4.client!hk", name = "<init>", descriptor = "()V")
	public TextureOpHslAdjust() {
		super(1, false);
	}

	@OriginalMember(owner = "runetek4.client!hk", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	public final void decode(@OriginalArg(1) Packet packet, @OriginalArg(0) int code) {
		if (code == 0) {
			...
			this.anInt2547 = (packet.g1s() << 12) / 100;
		}
	}

	@OriginalMember(owner = "runetek4.client!hk", name = "a", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "runetek4.client!hk", name = "a", descriptor = "(BIII)V")
	...
	@OriginalMember(owner = "runetek4.client!hk", name = "b", descriptor = "(II)[[I")
	@Override
