...
public final class TextureOpRange extends TextureOp {
	...
	@OriginalMember(owner = "runetek4.client!fh", name = "db", descriptor = "I")
	private int anInt2001 = 2048;

	@OriginalMember(owner = "runetek4.client!fh", name = "eb", descriptor = "I")
	...
	public final int[][] getColorOutput(@OriginalArg(1) int arg0) {
		@Pc(7) int[][] local7 = this.clearImageCache.get(arg0);
