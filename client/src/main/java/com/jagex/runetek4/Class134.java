...
@OriginalClass("runetek4.client!se")
public final class Class134 {

	@OriginalMember(owner = "runetek4.client!se", name = "i", descriptor = "I")
	public final int anInt5074;

	@OriginalMember(owner = "runetek4.client!se", name = "j", descriptor = "[Lclient!na;")
	public final JagString[] aClass100Array153;

	@OriginalMember(owner = "runetek4.client!se", name = "d", descriptor = "[S")
	public final short[] aShortArray72;

	@OriginalMember(owner = "runetek4.client!se", name = "n", descriptor = "[I")
	public final int[] anIntArray444;

	@OriginalMember(owner = "runetek4.client!se", name = "u", descriptor = "[B")
	public final byte[] aByteArray69;

	@OriginalMember(owner = "runetek4.client!se", name = "q", descriptor = "[S")
	public final short[] aShortArray73;

	@OriginalMember(owner = "runetek4.client!se", name = "<init>", descriptor = "(I)V")
