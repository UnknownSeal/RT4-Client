	...
	public static void method4240(@OriginalArg(0) NpcType npc, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		...
		if (Static260.anInt5014 == 1) {
			...
			if ((Static274.anInt4999 & 0x2) != 0 && (local378 == null || npc.getParam(Static121.anInt3039, local378.anInt2667) != local378.anInt2667)) {
				Static98.addActionRow(anInt5393, (long) arg2, Static34.method882(new JString[] { Static78.aClass100_466, Static201.aClass100_407, tooltip }), arg1, (short) 45, Static102.aClass100_545, arg3);
			}
		} else {
			...
			if (spellSelected != null) {
				for (op = 4; op >= 0; op--) {
					if (spellSelected[op] != null && (Static266.game != 0 || !spellSelected[op].equalsIgnoreCase(LocalizedText.ATTACK))) {
						...
						Static98.addActionRow(local176, (long) arg2, Static34.method882(new JString[] { Static226.YELLOW2, tooltip }), arg1, local161, spellSelected[op], arg3);
					}
				}
			}
			if (Static266.game == 0 && spellSelected != null) {
				for (op = 4; op >= 0; op--) {
					if (spellSelected[op] != null && spellSelected[op].equalsIgnoreCase(LocalizedText.ATTACK)) {
						...
						Static98.addActionRow(npc.cursorattack, (long) arg2, Static34.method882(new JString[] { Static226.YELLOW2, tooltip }), arg1, menuOption, spellSelected[op], arg3);
					}
				}
			}
			Static98.addActionRow(Static225.anInt5073, (long) arg2, Static34.method882(new JString[] { Static226.YELLOW2, tooltip }), arg1, (short) 1007, LocalizedText.EXAMINE, arg3);
		}
	}
