...
public final class Static185 {
	...
	public static void method3397(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) CollisionMap arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9) {
		...
		if (GlRenderer.enabled && local62.istexture) {
			return;
		}
		@Pc(84) int local84;
		@Pc(81) int local81;
		if (arg9 == 1 || arg9 == 3) {
			...
			local84 = local62.height;
		} else {
			local84 = local62.width;
			local81 = local62.height;
		}
		@Pc(103) int local103;
		@Pc(112) int local112;
		if (arg7 + local84 <= 104) {
		...
		if (local62.active == 0 || arg3) {
			local261 |= Long.MIN_VALUE;
		}
		if (local62.raiseobject == 1) {
			local261 |= 0x400000L;
		}
		...
		@Pc(330) boolean local330 = local62.hardshadow & !arg3;
		local261 |= (long) arg5 << 32;
		@Pc(387) Entity local387;
		@Pc(403) Class139 local403;
		if (arg6 == 22) {
			if (Static250.aBoolean283 || local62.active != 0 || local62.blockwalk == 1 || local62.forcedecor) {
				if (local62.seqindex == -1 && local62.multiloc == null && !local62.aBoolean214) {
					...
					local387 = new Loc(arg5, 22, arg9, arg0, arg7, arg8, local62.seqindex, local62.randseq, null);
				}
			...
			if (local62.seqindex == -1 && local62.multiloc == null && !local62.aBoolean214) {
				...
				local387 = new Loc(arg5, 10, arg6 == 11 ? arg9 + 4 : arg9, arg0, arg7, arg8, local62.seqindex, local62.randseq, null);
			}
			if (local387 != null) {
				@Pc(531) boolean local531 = Static5.method35(arg2, arg7, arg8, local199, local84, local81, local387, local261);
				if (local62.shadow && local531 && arg1) {
			...
			if (local62.seqindex == -1 && local62.multiloc == null && !local62.aBoolean214) {
				...
				local387 = new Loc(arg5, arg6, arg9, arg0, arg7, arg8, local62.seqindex, local62.randseq, null);
			}
			...
			if (local62.seqindex == -1 && local62.multiloc == null && !local62.aBoolean214) {
				...
				local387 = new Loc(arg5, 0, arg9, arg0, arg7, arg8, local62.seqindex, local62.randseq, null);
			}
			...
			if (local62.seqindex == -1 && local62.multiloc == null && !local62.aBoolean214) {
				...
				local387 = new Loc(arg5, 1, arg9, arg0, arg7, arg8, local62.seqindex, local62.randseq, null);
			}
			...
			if (arg6 == 2) {
				...
				if (local62.seqindex == -1 && local62.multiloc == null && !local62.aBoolean214) {
					...
					local1254 = new Loc(arg5, 2, arg9 + 4, arg0, arg7, arg8, local62.seqindex, local62.randseq, null);
					local1269 = new Loc(arg5, 2, local1226, arg0, arg7, arg8, local62.seqindex, local62.randseq, null);
				}
				...
				if (local62.seqindex == -1 && local62.multiloc == null && !local62.aBoolean214) {
					...
					local387 = new Loc(arg5, 3, arg9, arg0, arg7, arg8, local62.seqindex, local62.randseq, null);
				}
				Static262.method4508(arg2, arg7, arg8, local199, local387, null, Static78.anIntArray204[arg9], 0, local261);
				if (local62.shadow && arg1) {
					if (arg9 == 0) {
				...
				if (local62.seqindex == -1 && local62.multiloc == null && !local62.aBoolean214) {
					...
					local387 = new Loc(arg5, 4, arg9, arg0, arg7, arg8, local62.seqindex, local62.randseq, null);
				}
				...
				if (arg6 == 5) {
					...
					if (local62.seqindex == -1 && local62.multiloc == null && !local62.aBoolean214) {
						...
						local1934 = new Loc(arg5, 4, arg9, arg0, arg7, arg8, local62.seqindex, local62.randseq, null);
					}
					...
					if (local62.seqindex == -1 && local62.multiloc == null && !local62.aBoolean214) {
						...
						local1934 = new Loc(arg5, 4, arg9 + 4, arg0, arg7, arg8, local62.seqindex, local62.randseq, null);
					}
					...
					if (local62.seqindex == -1 && local62.multiloc == null && !local62.aBoolean214) {
						...
						local387 = new Loc(arg5, 4, local2137 + 4, arg0, arg7, arg8, local62.seqindex, local62.randseq, null);
					}
					...
					if (local62.seqindex == -1 && local62.multiloc == null && !local62.aBoolean214) {
						...
						local1934 = new Loc(arg5, 4, arg9 + 4, arg0, arg7, arg8, local62.seqindex, local62.randseq, null);
						local2289 = new Loc(arg5, 4, local2244 + 4, arg0, arg7, arg8, local62.seqindex, local62.randseq, null);
					}
