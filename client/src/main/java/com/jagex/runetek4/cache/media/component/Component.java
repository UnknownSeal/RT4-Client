...
public final class Component {
	...
	public Sprite method482(@OriginalArg(1) int arg0) {
		...
		local43 = SpriteLoader.loadSprites(local29, InterfaceList.gameImageJs5);
		if (local43 == null) {
			aBoolean72 = true;
		} else {
	...
	public Sprite method489(@OriginalArg(1) boolean arg0) {
		...
		if (this.hasAlpha) {
			local85 = SoftwareSprite.loadSoftwareAlphaSprite(InterfaceList.gameImageJs5, local12);
		} else {
			local85 = SpriteLoader.loadSoftwareSprite(0, InterfaceList.gameImageJs5, local12);
		}
		if (local85 == null) {
			aBoolean72 = true;
			return null;
