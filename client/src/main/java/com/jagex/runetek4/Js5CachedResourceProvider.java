...
public final class Js5CachedResourceProvider extends Js5ResourceProvider {
	...
	@OriginalMember(owner = "runetek4.client!bg", name = "m", descriptor = "Lclient!ii;")
	private Js5Index aClass70_1;

	@OriginalMember(owner = "runetek4.client!bg", name = "w", descriptor = "[B")
	private byte[] aByteArray9;

	@OriginalMember(owner = "runetek4.client!bg", name = "T", descriptor = "Z")
	private boolean aBoolean36;

	@OriginalMember(owner = "runetek4.client!bg", name = "u", descriptor = "I")
	...
	@OriginalMember(owner = "runetek4.client!bg", name = "R", descriptor = "Lclient!ih;")
	private final LinkedList aClass69_16 = new LinkedList();

	@OriginalMember(owner = "runetek4.client!bg", name = "V", descriptor = "J")
	private long aLong20 = 0L;

	@OriginalMember(owner = "runetek4.client!bg", name = "L", descriptor = "I")
	private final int anInt576;

	@OriginalMember(owner = "runetek4.client!bg", name = "F", descriptor = "Lclient!ge;")
	private final Cache aClass49_2;

	@OriginalMember(owner = "runetek4.client!bg", name = "Q", descriptor = "Z")
	private boolean aBoolean35;

	@OriginalMember(owner = "runetek4.client!bg", name = "U", descriptor = "Lclient!ih;")
	private LinkedList aClass69_17;

	@OriginalMember(owner = "runetek4.client!bg", name = "J", descriptor = "Lclient!k;")
	private final Js5CacheQueue aClass80_2;

	@OriginalMember(owner = "runetek4.client!bg", name = "H", descriptor = "I")
	private final int anInt573;

	@OriginalMember(owner = "runetek4.client!bg", name = "W", descriptor = "Z")
	private final boolean aBoolean37;

	@OriginalMember(owner = "runetek4.client!bg", name = "k", descriptor = "Lclient!ge;")
	private final Cache aClass49_1;

	@OriginalMember(owner = "runetek4.client!bg", name = "D", descriptor = "Lclient!jb;")
	private final Js5NetQueue aClass73_2;

	@OriginalMember(owner = "runetek4.client!bg", name = "t", descriptor = "I")
	private final int anInt566;

	@OriginalMember(owner = "runetek4.client!bg", name = "x", descriptor = "Lclient!il;")
	private Js5Request aClass3_Sub2_Sub5_1;

	@OriginalMember(owner = "runetek4.client!bg", name = "<init>", descriptor = "(ILclient!ge;Lclient!ge;Lclient!jb;Lclient!k;IIZ)V")
	...
	@OriginalMember(owner = "runetek4.client!bg", name = "a", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!bg", name = "a", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "runetek4.client!bg", name = "c", descriptor = "(I)I")
	public final int method529() {
		return this.anInt567;
	}

	@OriginalMember(owner = "runetek4.client!bg", name = "d", descriptor = "(I)I")
	...
	public final int getPercentageComplete(@OriginalArg(0) int arg0) {
		...
		return local15 == null ? 0 : local15.getPercentageComplewte();
	}
	...
	private Js5Request method536(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (!(local13 instanceof Js5CacheRequest)) {
			try {
				...
				if (this.aClass70_1.crcs[arg1] != local199) {
					throw new RuntimeException();
				}
	...
	public final void method537() {
		...
		for (@Pc(21) Node local21 = this.aClass69_16.method2289(); local21 != null; local21 = this.aClass69_16.method2288()) {
			...
			if (local28 < 0 || this.aClass70_1.anInt2907 <= local28 || this.aClass70_1.groupSizes[local28] == 0) {
				local21.remove();
			} else {
	...
	public final int method538() {
		if (this.fetchindex() == null) {
			return this.aClass3_Sub2_Sub5_1 == null ? 0 : this.aClass3_Sub2_Sub5_1.getPercentageComplewte();
		} else {
			return 100;
		}
	}

	@OriginalMember(owner = "runetek4.client!bg", name = "c", descriptor = "(II)[B")
	@Override
	public final byte[] fetchgroup(@OriginalArg(0) int group) {
		@Pc(9) Js5Request local9 = this.method536(0, group);
		if (local9 == null) {
			return null;
		} else {
