...
public final class Static75 {
	...
	public static void method1629(@OriginalArg(1) boolean arg0) {
		...
		if (!Static230.aBoolean250) {
			...
			local20 = (Static223.packetSize - Static57.in.offset) / 16;
			...
			for (local138 = (local31 - 6) / 8; local138 <= (local31 + 6) / 8; local138++) {
				for (local151 = (local60 - 6) / 8; local151 <= (local60 + 6) / 8; local151++) {
					...
					if (local100 && (local151 == 49 || local151 == 149 || local151 == 147 || local138 == 50 || local138 == 49 && local151 == 47)) {
						...
						Static238.anIntArray470[local20] = local169;
						Static36.anIntArray84[local20] = Static26.aClass153_16.method4482(JString.concatenate(new JString[] { Static103.aClass100_558, JString.parseInt(local138), Static86.aClass100_488, JString.parseInt(local151) }));
						Static172.anIntArray366[local20] = Static26.aClass153_16.method4482(JString.concatenate(new JString[] { Static270.aClass100_1090, JString.parseInt(local138), Static86.aClass100_488, JString.parseInt(local151) }));
						Static99.anIntArray239[local20] = Static26.aClass153_16.method4482(JString.concatenate(new JString[] { Static165.aClass100_772, JString.parseInt(local138), Static86.aClass100_488, JString.parseInt(local151) }));
						Static35.anIntArray82[local20] = Static26.aClass153_16.method4482(JString.concatenate(new JString[] { Static278.aClass100_1103, JString.parseInt(local138), Static86.aClass100_488, JString.parseInt(local151) }));
					}
					local20++;
				}
			}
		...
		local60 = (Static223.packetSize - Static57.in.offset) / 16;
				...
				for (local151 = 0; local151 < 13; local151++) {
					...
					if (local169 != -1) {
						...
						if (local571 != -1) {
							...
							Static36.anIntArray84[local60] = Static26.aClass153_16.method4482(JString.concatenate(new JString[] { Static103.aClass100_558, JString.parseInt(local573), Static86.aClass100_488, JString.parseInt(local609) }));
							Static172.anIntArray366[local60] = Static26.aClass153_16.method4482(JString.concatenate(new JString[] { Static270.aClass100_1090, JString.parseInt(local573), Static86.aClass100_488, JString.parseInt(local609) }));
							Static99.anIntArray239[local60] = Static26.aClass153_16.method4482(JString.concatenate(new JString[] { Static165.aClass100_772, JString.parseInt(local573), Static86.aClass100_488, JString.parseInt(local609) }));
							Static35.anIntArray82[local60] = Static26.aClass153_16.method4482(JString.concatenate(new JString[] { Static278.aClass100_1103, JString.parseInt(local573), Static86.aClass100_488, JString.parseInt(local609) }));
							local60++;
						}
					}
				}
	...
	public static void method1634() {
		...
		if (Static164.packetType == 195) {
			...
			if (local19 >= 0 && local27 >= 0 && local19 < 104 && local27 < 104) {
				...
				if (Static159.levelObjStacks[Player.plane][local19][local27] == null) {
					Static159.levelObjStacks[Player.plane][local19][local27] = new LinkedList();
				}
				Static159.levelObjStacks[Player.plane][local19][local27].addTail(new ObjStackNode(local122));
			...
			if (Static164.packetType == 121) {
				...
				if (Static164.packetType == 14) {
					...
					local39 = Static57.in.g2();
					if (local23 >= 0 && local19 >= 0 && local23 < 104 && local19 < 104) {
						@Pc(710) LinkedList local710 = Static159.levelObjStacks[Player.plane][local23][local19];
						if (local710 != null) {
					...
					if (local19 >= 0 && local27 >= 0 && local19 < 104 && local27 < 104 && PlayerList.selfId != local15) {
						...
						Static159.levelObjStacks[Player.plane][local19][local27].addTail(new ObjStackNode(local812));
						Static220.method3797(local27, local19);
					}
					...
					if (local23 >= 0 && local19 >= 0 && local23 < 104 && local19 < 104) {
						local224 = local39 + 1;
						if (PlayerList.self.pathTileX[0] >= local23 - local224 && local224 + local23 >= PlayerList.self.pathTileX[0] && PlayerList.self.pathTileZ[0] >= local19 - local224 && PlayerList.self.pathTileZ[0] <= local224 + local19 && Preferences.ambientSoundsVolume != 0 && local45 > 0 && Static189.anInt4451 < 50 && local27 != -1) {
					...
					local27 = Static57.in.g2();
					if (local23 >= 0 && local19 >= 0 && local23 < 104 && local19 < 104) {
						@Pc(1565) LinkedList local1565 = Static159.levelObjStacks[Player.plane][local23][local19];
						if (local1565 != null) {
							...
							if (local1565.head() == null) {
								Static159.levelObjStacks[Player.plane][local23][local19] = null;
							}
							Static220.method3797(local19, local23);
						}
					}
