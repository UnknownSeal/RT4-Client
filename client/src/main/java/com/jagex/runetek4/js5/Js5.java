...
public final class Js5 {
	...
	public int method4478(@OriginalArg(1) JString arg0) {
		if (this.isIndexReady()) {
			...
			@Pc(29) int local29 = this.index.intHashTable.get(local15.getHash());
	...
	public int getGroupId(@OriginalArg(0) JString arg0) {
		if (this.isIndexReady()) {
			...
			@Pc(27) int local27 = this.index.intHashTable.get(local16.getHash());
	...
	public byte[] fetchFile(@OriginalArg(1) JString arg0, @OriginalArg(2) JString arg1) {
		...
		@Pc(28) int local28 = this.index.intHashTable.get(local15.getHash());
		if (this.isGroupValid(local28)) {
			@Pc(53) int local53 = this.index.aClass76Array1[local28].get(local19.getHash());
	...
	public void method4486(@OriginalArg(1) JString arg0) {
		if (this.isIndexReady()) {
			...
			@Pc(22) int local22 = this.index.intHashTable.get(local13.getHash());
	...
	public boolean isFileReady(@OriginalArg(0) JString arg0, @OriginalArg(2) JString arg1) {
		...
		@Pc(30) int local30 = this.index.intHashTable.get(local17.getHash());
		if (this.isGroupValid(local30)) {
			@Pc(49) int local49 = this.index.aClass76Array1[local30].get(local21.getHash());
	...
	public boolean method4489(@OriginalArg(1) JString arg0) {
		if (this.isIndexReady()) {
			...
			@Pc(25) int local25 = this.index.intHashTable.get(local14.getHash());
	...
	public boolean method4497(@OriginalArg(0) JString arg0) {
		if (this.isIndexReady()) {
			@Pc(19) JString local19 = arg0.toLowerCase();
			@Pc(28) int local28 = this.index.intHashTable.get(local19.getHash());
			return local28 >= 0;
		} else {
			return false;
		}
