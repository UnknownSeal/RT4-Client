...
public final class WaterMaterialRenderer implements MaterialRenderer {
	...
	@OriginalMember(owner = "runetek4.client!pd", name = "a", descriptor = "I")
	private int anInt4440 = -1;

	@OriginalMember(owner = "runetek4.client!pd", name = "c", descriptor = "[F")
	private final float[] aFloatArray23 = new float[4];

	@OriginalMember(owner = "runetek4.client!pd", name = "d", descriptor = "I")
	private int anInt4441 = -1;

	@OriginalMember(owner = "runetek4.client!pd", name = "e", descriptor = "I")
	private int anInt4442 = -1;

	@OriginalMember(owner = "runetek4.client!pd", name = "<init>", descriptor = "()V")
	public WaterMaterialRenderer() {
		this.method3435();
		this.method3437();
	}

	@OriginalMember(owner = "runetek4.client!pd", name = "d", descriptor = "()V")
	...
	@OriginalMember(owner = "runetek4.client!pd", name = "f", descriptor = "()V")
	...
	@OriginalMember(owner = "runetek4.client!pd", name = "a", descriptor = "()V")
	@Override
	public final void unbind() {
		GlRenderer.gl.glCallList(this.anInt4440 + 1);
	}

	@OriginalMember(owner = "runetek4.client!pd", name = "a", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!pd", name = "b", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!pd", name = "c", descriptor = "()I")
	@Override
