...
import com.jagex.runetek4.FogManager;
...
public class ColorUtils {
    ...
    public static int multiplyLightness(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    ...
    public static int multiplyLightness2(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
        arg1 = arg1 * (arg0 & 0x7F) >> 7;
        if (arg1 < 2) {
            arg1 = 2;
        } else if (arg1 > 126) {
    ...
    public static int multiplyLightness3(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
        arg1 = arg1 * (arg0 & 0x7F) >> 7;
        if (arg1 < 2) {
            arg1 = 2;
        } else if (arg1 > 126) {
