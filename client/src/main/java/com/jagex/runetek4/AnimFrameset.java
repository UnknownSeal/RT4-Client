...
@OriginalClass("runetek4.client!cl")
public final class AnimFrameset extends SecondaryNode {

	@OriginalMember(owner = "runetek4.client!cl", name = "W", descriptor = "[Lclient!ne;")
	public final AnimFrame[] aClass104Array1;

	@OriginalMember(owner = "runetek4.client!cl", name = "<init>", descriptor = "(Lclient!ve;Lclient!ve;IZ)V")
	...
	@OriginalMember(owner = "runetek4.client!cl", name = "c", descriptor = "(II)Z")
	public final boolean method901(@OriginalArg(1) int arg0) {
		return this.aClass104Array1[arg0].aBoolean197;
	}

	@OriginalMember(owner = "runetek4.client!cl", name = "a", descriptor = "(IB)Z")
