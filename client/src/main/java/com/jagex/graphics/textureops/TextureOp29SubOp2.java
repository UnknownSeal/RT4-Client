...
@OriginalClass("runetek4.client!kc")
public final class TextureOp29SubOp2 extends TextureOp29SubOp {
	...
	@OriginalMember(owner = "runetek4.client!kc", name = "B", descriptor = "I")
	private final int anInt3168;

	@OriginalMember(owner = "runetek4.client!kc", name = "y", descriptor = "I")
	private final int anInt3165;

	@OriginalMember(owner = "runetek4.client!kc", name = "v", descriptor = "I")
	private final int anInt3163;

	@OriginalMember(owner = "runetek4.client!kc", name = "m", descriptor = "I")
	private final int anInt3159;

	@OriginalMember(owner = "runetek4.client!kc", name = "<init>", descriptor = "(IIIIIII)V")
	...
	public static void method898(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		...
		if (arg4 >= TextureOpRasterizer.anInt5773 && TextureOpRasterizer.anInt2869 >= arg4) {
			local95 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg2 + arg3, TextureOpRasterizer.anInt4164);
			local104 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg3 - arg2, TextureOpRasterizer.anInt4164);
		...
		while (local17 > 0) {
			...
			if (TextureOpRasterizer.anInt5773 <= local104 && TextureOpRasterizer.anInt2869 >= local95) {
				@Pc(213) int local213 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, local15 + arg3, TextureOpRasterizer.anInt4164);
				@Pc(222) int local222 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg3 - local15, TextureOpRasterizer.anInt4164);
				if (local95 >= TextureOpRasterizer.anInt5773) {
					ArrayUtils.fillRange(ObjTypeList.anIntArrayArray10[local95], local222, local213, arg0);
				}
				if (TextureOpRasterizer.anInt2869 >= local104) {
	...
	public static void method1623(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		} else if (arg1 - arg6 >= TextureOpRasterizer.anInt4164 && arg6 + arg1 <= FloorUnderlayTypeList.anInt5063 && TextureOpRasterizer.anInt5773 <= arg2 - arg3 && TextureOpRasterizer.anInt2869 >= arg2 + arg3) {
	...
	public static void method1760(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg1 - arg0 >= TextureOpRasterizer.anInt4164 && FloorUnderlayTypeList.anInt5063 >= arg0 + arg1 && arg3 - arg0 >= TextureOpRasterizer.anInt5773 && TextureOpRasterizer.anInt2869 >= arg0 + arg3) {
	...
	public static void method1843(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3) {
		...
		@Pc(14) int local14 = -1;
		@Pc(22) int local22 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg2 + arg3, TextureOpRasterizer.anInt4164);
		@Pc(30) int local30 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg3 - arg2, TextureOpRasterizer.anInt4164);
		...
		while (local7 < local9) {
			...
			if (local12 > 0) {
				...
				local12 -= local9 << 1;
				local68 = arg1 + local9;
				if (local68 >= TextureOpRasterizer.anInt5773 && local58 <= TextureOpRasterizer.anInt2869) {
					local84 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg3 + local7, TextureOpRasterizer.anInt4164);
					local93 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg3 - local7, TextureOpRasterizer.anInt4164);
					if (TextureOpRasterizer.anInt2869 >= local68) {
						ArrayUtils.fillRange(ObjTypeList.anIntArrayArray10[local68], local93, local84, arg0);
					}
					if (TextureOpRasterizer.anInt5773 <= local58) {
			...
			local58 = arg1 - local7;
			local68 = local7 + arg1;
			if (local68 >= TextureOpRasterizer.anInt5773 && TextureOpRasterizer.anInt2869 >= local58) {
				local84 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg3 + local9, TextureOpRasterizer.anInt4164);
				local93 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg3 - local9, TextureOpRasterizer.anInt4164);
				if (local68 <= TextureOpRasterizer.anInt2869) {
					ArrayUtils.fillRange(ObjTypeList.anIntArrayArray10[local68], local93, local84, arg0);
				}
				if (local58 >= TextureOpRasterizer.anInt5773) {
					ArrayUtils.fillRange(ObjTypeList.anIntArrayArray10[local58], local93, local84, arg0);
				}
			}
		}
	...
	public static void method2826(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		if (arg4 - arg3 >= TextureOpRasterizer.anInt4164 && FloorUnderlayTypeList.anInt5063 >= arg4 + arg3 && TextureOpRasterizer.anInt5773 <= arg1 - arg3 && TextureOpRasterizer.anInt2869 >= arg3 + arg1) {
	...
	public static void method3163(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4) {
		...
		} else if (TextureOpRasterizer.anInt4164 <= arg2 - arg4 && arg2 + arg4 <= FloorUnderlayTypeList.anInt5063 && arg3 - arg1 >= TextureOpRasterizer.anInt5773 && arg3 + arg1 <= TextureOpRasterizer.anInt2869) {
	...
	public static void method4670(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		...
		@Pc(78) int local78;
		@Pc(87) int local87;
		if (arg1 >= TextureOpRasterizer.anInt5773 && TextureOpRasterizer.anInt2869 >= arg1) {
			@Pc(52) int[] local52 = ObjTypeList.anIntArrayArray10[arg1];
			local61 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg5 - arg2, TextureOpRasterizer.anInt4164);
			local69 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg2 + arg5, TextureOpRasterizer.anInt4164);
			local78 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg5 - local18, TextureOpRasterizer.anInt4164);
			local87 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg5 + local18, TextureOpRasterizer.anInt4164);
		...
		while (local23 < local32) {
			...
			if (local35 >= 0) {
				...
				if (TextureOpRasterizer.anInt5773 <= local61 && TextureOpRasterizer.anInt2869 >= local161) {
					if (local32 >= local18) {
						local69 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, local23 + arg5, TextureOpRasterizer.anInt4164);
						local78 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg5 - local23, TextureOpRasterizer.anInt4164);
						if (TextureOpRasterizer.anInt2869 >= local61) {
							ArrayUtils.fillRange(ObjTypeList.anIntArrayArray10[local61], local78, local69, arg3);
						}
						if (local161 >= TextureOpRasterizer.anInt5773) {
							ArrayUtils.fillRange(ObjTypeList.anIntArrayArray10[local161], local78, local69, arg3);
						}
					} else {
						local69 = anIntArray522[local32];
						local78 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, local23 + arg5, TextureOpRasterizer.anInt4164);
						local87 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg5 - local23, TextureOpRasterizer.anInt4164);
						local264 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg5 + local69, TextureOpRasterizer.anInt4164);
						local273 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg5 - local69, TextureOpRasterizer.anInt4164);
						if (TextureOpRasterizer.anInt2869 >= local61) {
			...
			if (TextureOpRasterizer.anInt5773 <= local61 && TextureOpRasterizer.anInt2869 >= local161) {
				...
				if (local69 >= TextureOpRasterizer.anInt4164 && FloorUnderlayTypeList.anInt5063 >= local78) {
					local69 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, local69, TextureOpRasterizer.anInt4164);
					local78 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, local78, TextureOpRasterizer.anInt4164);
					if (local23 < local18) {
						local87 = local40 >= local23 ? local40 : anIntArray522[local23];
						local264 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, local87 + arg5, TextureOpRasterizer.anInt4164);
						local273 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg5 - local87, TextureOpRasterizer.anInt4164);
						if (TextureOpRasterizer.anInt2869 >= local61) {
							local280 = ObjTypeList.anIntArrayArray10[local61];
	...
	@OriginalMember(owner = "runetek4.client!kc", name = "c", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!kc", name = "a", descriptor = "(IZI)V")
	@Override
	public final void method4009(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
	}

	@OriginalMember(owner = "runetek4.client!kc", name = "a", descriptor = "(III)V")
	@Override
