...
@OriginalClass("runetek4.client!vc")
public final class TextureOpLineNoise extends TextureOp {

	@OriginalMember(owner = "runetek4.client!vc", name = "P", descriptor = "I")
	private int anInt5709 = 0;

	@OriginalMember(owner = "runetek4.client!vc", name = "U", descriptor = "I")
	private int anInt5712 = 2000;

	@OriginalMember(owner = "runetek4.client!vc", name = "Z", descriptor = "I")
	private int anInt5715 = 16;

	@OriginalMember(owner = "runetek4.client!vc", name = "Y", descriptor = "I")
	private int anInt5714 = 4096;

	@OriginalMember(owner = "runetek4.client!vc", name = "cb", descriptor = "I")
	private int anInt5716 = 0;

	@OriginalMember(owner = "runetek4.client!vc", name = "<init>", descriptor = "()V")
