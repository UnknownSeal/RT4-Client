...
import com.jagex.core.utils.RandomUtils;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("runetek4.client!mc")
public final class TextureOpBricks extends TextureOp {

	@OriginalMember(owner = "runetek4.client!mc", name = "U", descriptor = "I")
	private int anInt3670;

	@OriginalMember(owner = "runetek4.client!mc", name = "V", descriptor = "I")
	private int anInt3671;

	@OriginalMember(owner = "runetek4.client!mc", name = "X", descriptor = "[[I")
	private int[][] anIntArrayArray26;

	@OriginalMember(owner = "runetek4.client!mc", name = "cb", descriptor = "[I")
	private int[] anIntArray352;

	@OriginalMember(owner = "runetek4.client!mc", name = "jb", descriptor = "I")
	private int anInt3679;

	@OriginalMember(owner = "runetek4.client!mc", name = "sb", descriptor = "[[I")
	private int[][] anIntArrayArray27;

	@OriginalMember(owner = "runetek4.client!mc", name = "P", descriptor = "I")
	private int anInt3667 = 204;

	@OriginalMember(owner = "runetek4.client!mc", name = "bb", descriptor = "I")
	private int anInt3673 = 1024;

	@OriginalMember(owner = "runetek4.client!mc", name = "eb", descriptor = "I")
	private int anInt3675 = 0;

	@OriginalMember(owner = "runetek4.client!mc", name = "lb", descriptor = "I")
	private int anInt3681 = 409;

	@OriginalMember(owner = "runetek4.client!mc", name = "hb", descriptor = "I")
	private int anInt3677 = 8;

	@OriginalMember(owner = "runetek4.client!mc", name = "W", descriptor = "I")
	private int anInt3672 = 81;

	@OriginalMember(owner = "runetek4.client!mc", name = "ub", descriptor = "I")
	private int anInt3685 = 4;

	@OriginalMember(owner = "runetek4.client!mc", name = "ib", descriptor = "I")
	private int anInt3678 = 1024;

	@OriginalMember(owner = "runetek4.client!mc", name = "<init>", descriptor = "()V")
	...
	@OriginalMember(owner = "runetek4.client!mc", name = "i", descriptor = "(I)V")
	...
	@OriginalMember(owner = "runetek4.client!mc", name = "a", descriptor = "(IB)[I")
	@Override
