...
public final class TextureOp29SubOp4 extends TextureOp29SubOp {
	...
	public static void method352(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(11) int local11 = IntMath.clamp(TextureOpRasterizer.anInt2869, arg5, TextureOpRasterizer.anInt5773);
		@Pc(17) int local17 = IntMath.clamp(TextureOpRasterizer.anInt2869, arg0, TextureOpRasterizer.anInt5773);
		@Pc(23) int local23 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg3, TextureOpRasterizer.anInt4164);
		@Pc(29) int local29 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg2, TextureOpRasterizer.anInt4164);
		@Pc(42) int local42 = IntMath.clamp(TextureOpRasterizer.anInt2869, arg5 + arg1, TextureOpRasterizer.anInt5773);
		@Pc(51) int local51 = IntMath.clamp(TextureOpRasterizer.anInt2869, arg0 - arg1, TextureOpRasterizer.anInt5773);
		@Pc(53) int local53;
		...
		@Pc(95) int local95 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg1 + arg3, TextureOpRasterizer.anInt4164);
		@Pc(104) int local104 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg2 - arg1, TextureOpRasterizer.anInt4164);
	...
	public static void method644(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		if (TextureOpRasterizer.anInt4164 <= arg6 && FloorUnderlayTypeList.anInt5063 >= arg5 && arg4 >= TextureOpRasterizer.anInt5773 && arg1 <= TextureOpRasterizer.anInt2869) {
	...
	public static void method3105(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		@Pc(11) int local11 = IntMath.clamp(TextureOpRasterizer.anInt2869, arg2, TextureOpRasterizer.anInt5773);
		@Pc(17) int local17 = IntMath.clamp(TextureOpRasterizer.anInt2869, arg4, TextureOpRasterizer.anInt5773);
		@Pc(23) int local23 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg3, TextureOpRasterizer.anInt4164);
		@Pc(35) int local35 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg1, TextureOpRasterizer.anInt4164);
	...
	public static void method3950(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		if (arg0 >= TextureOpRasterizer.anInt4164 && arg3 <= FloorUnderlayTypeList.anInt5063 && TextureOpRasterizer.anInt5773 <= arg4 && TextureOpRasterizer.anInt2869 >= arg2) {
	...
	public static void method4222(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		@Pc(11) int local11 = IntMath.clamp(TextureOpRasterizer.anInt2869, arg5, TextureOpRasterizer.anInt5773);
		@Pc(17) int local17 = IntMath.clamp(TextureOpRasterizer.anInt2869, arg2, TextureOpRasterizer.anInt5773);
		@Pc(23) int local23 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg6, TextureOpRasterizer.anInt4164);
		@Pc(29) int local29 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg0, TextureOpRasterizer.anInt4164);
		@Pc(37) int local37 = IntMath.clamp(TextureOpRasterizer.anInt2869, arg3 + arg5, TextureOpRasterizer.anInt5773);
		@Pc(46) int local46 = IntMath.clamp(TextureOpRasterizer.anInt2869, arg2 - arg3, TextureOpRasterizer.anInt5773);
		@Pc(48) int local48;
		...
		@Pc(94) int local94 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg3 + arg6, TextureOpRasterizer.anInt4164);
		@Pc(103) int local103 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg0 - arg3, TextureOpRasterizer.anInt4164);
	...
	public static void method4244(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		if (TextureOpRasterizer.anInt4164 <= arg1 && FloorUnderlayTypeList.anInt5063 >= arg3 && TextureOpRasterizer.anInt5773 <= arg2 && arg4 <= TextureOpRasterizer.anInt2869) {
			if (arg5 == 1) {
