...
import com.jagex.graphics.cache.ColorImageCache;
import com.jagex.graphics.cache.MonochromeImageCache;
...
public abstract class TextureOp extends Node {
	...
	protected TextureOp(@OriginalArg(0) int arg0, @OriginalArg(1) boolean monochrome) {
