...
public final class TextureOpIrregularBricks extends TextureOp {
	...
	@OriginalMember(owner = "runetek4.client!ol", name = "R", descriptor = "I")
	private int anInt4346 = 819;

	@OriginalMember(owner = "runetek4.client!ol", name = "ab", descriptor = "I")
	private int anInt4351 = 0;

	@OriginalMember(owner = "runetek4.client!ol", name = "Z", descriptor = "I")
	private int anInt4350 = 2048;

	@OriginalMember(owner = "runetek4.client!ol", name = "T", descriptor = "I")
	private int anInt4347 = 1024;

	@OriginalMember(owner = "runetek4.client!ol", name = "Q", descriptor = "I")
	private int anInt4345 = 1024;

	@OriginalMember(owner = "runetek4.client!ol", name = "cb", descriptor = "I")
	private int anInt4353 = 409;

	@OriginalMember(owner = "runetek4.client!ol", name = "kb", descriptor = "I")
	private int anInt4360 = 1024;

	@OriginalMember(owner = "runetek4.client!ol", name = "P", descriptor = "I")
	private int anInt4344 = 1024;

	@OriginalMember(owner = "runetek4.client!ol", name = "eb", descriptor = "I")
	...
	@OriginalMember(owner = "runetek4.client!ol", name = "e", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!ol", name = "a", descriptor = "(ILclient!wa;Z)V")
	@Override
	public final void decode(@OriginalArg(1) Packet packet, @OriginalArg(0) int code) {
		if (code == 0) {
			this.anInt4354 = packet.g1();
		} else if (code == 1) {
			this.anInt4345 = packet.g2();
		} else if (code == 2) {
			this.anInt4350 = packet.g2();
		} else if (code == 3) {
			this.anInt4353 = packet.g2();
		} else if (code == 4) {
			this.anInt4346 = packet.g2();
		} else if (code == 5) {
			this.anInt4347 = packet.g2();
		} else if (code == 6) {
			this.anInt4351 = packet.g1();
		} else if (code == 7) {
			this.anInt4344 = packet.g2();
		} else if (code == 8) {
			this.anInt4360 = packet.g2();
		}
	}
}
