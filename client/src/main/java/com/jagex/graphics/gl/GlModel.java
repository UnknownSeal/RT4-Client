...
import com.jagex.graphics.geometry.TriangleNormal;
import com.jagex.graphics.geometry.VertexNormal;
...
public final class GlModel extends Model {
	...
	public GlModel(@OriginalArg(0) RawModel model, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		...
		for (@Pc(32) int local32 = 0; local32 < model.triangleCount; local32++) {
			if ((model.triangleInfo == null || model.triangleInfo[local32] != 2) && (model.unmodifiedTriangleTexture == null || model.unmodifiedTriangleTexture[local32] == -1 || !Rasterizer.textureProvider.method3231(model.unmodifiedTriangleTexture[local32] & 0xFFFF))) {
		...
		for (local117 = 0; local117 < this.triangleCount; local117++) {
			...
			if (model.unmodifiedTriangleTexture != null) {
				local135 = model.unmodifiedTriangleTexture[local125];
				if (local135 != -1) {
					local131 = Rasterizer.textureProvider.getMaterialType(local135 & 0xFFFF);
		...
		if (model.triangleTextureIndex != null) {
			local439 = model.texturedFaceCount;
		...
		for (local439 = 0; local439 < this.triangleCount; local439++) {
			...
			local817 = model.unmodifiedTriangleColour[local810] & 0xFFFF;
			if (model.unmodifiedTriangleTexture == null) {
				local822 = -1;
			} else {
				local822 = model.unmodifiedTriangleTexture[local810];
			}
			@Pc(833) int local833;
			if (model.triangleTextureIndex == null) {
				local833 = -1;
				...
				if (local833 == -1) {
					...
					if (local902 == 0) {
						...
						if (local902 == 1) {
							...
							local960 = (float) model.textureTriangleTranslationU[local833] / 256.0F;
							local968 = (float) model.textureTriangleTranslationV[local833] / 256.0F;
			...
			if (model.unmodifiedTriangleTexture == null) {
				...
				this.triangleTextures[local439] = model.unmodifiedTriangleTexture[local810];
			}
			if (this.triangleBones != null) {
				this.triangleBones[local439] = (byte) model.triangleBones[local810];
			}
			this.triangleColors[local439] = model.unmodifiedTriangleColour[local810];
			if (model.triangleAlpha != null) {
	...
	public static int method4096(@OriginalArg(0) int arg0, @OriginalArg(1) short arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		...
		if (arg1 != -1) {
			...
			local21 = Rasterizer.textureProvider.method3229(arg1 & 0xFFFF);
			if (local21 != 0) {
				local21 += 256;
	...
	public final Model copy(@OriginalArg(0) boolean copyVertices, @OriginalArg(1) boolean copyNormals, @OriginalArg(2) boolean copyTextures) {
		return this.method4114(copyVertices, copyNormals, copyTextures, aClass8_Sub1_Sub1_4, aClass8_Sub1_Sub1_3);
	}
	...
	public void render(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) long arg8, @OriginalArg(9) int arg9, @OriginalArg(10) ParticleSystem arg10) {
		...
		if (arg8 > 0L && RawModel.allowInput && local70 > 0) {
			...
			if (anInt3582 >= local187 && anInt3582 <= local191 && RawModel.anInt1053 >= local206 && RawModel.anInt1053 <= local210) {
				...
				if (anInt3582 >= local187 && anInt3582 <= local191 && RawModel.anInt1053 >= local206 && RawModel.anInt1053 <= local210) {
					if (this.pickable) {
						Model.aLongArray11[MiniMenu.pickedEntityCount++] = arg8;
					} else {
	...
	@Override
	public Model createVariant(@OriginalArg(0) boolean shareVertices, @OriginalArg(1) boolean shareNormals, @OriginalArg(2) boolean shareTextures) {
		return this.method4114(shareVertices, shareNormals, shareTextures, aClass8_Sub1_Sub1_6, aClass8_Sub1_Sub1_5);
	}
	...
	protected void method4577(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int[] arg7) {
		...
		if (arg0 == 2) {
			...
			if (this.anIntArrayArray37 != null && this.triangleAlpha != null) {
				for (local18 = 0; local18 < local2; local18++) {
					local26 = arg1[local18];
	...
	public void resize(@OriginalArg(0) int scaleX, @OriginalArg(1) int scaleY, @OriginalArg(2) int scaleZ) {
		for (@Pc(1) int local1 = 0; local1 < this.vertexCount; local1++) {
			this.vertexX[local1] = this.vertexX[local1] * scaleX >> 7;
			this.vertexY[local1] = this.vertexY[local1] * scaleY >> 7;
			this.vertexZ[local1] = this.vertexZ[local1] * scaleZ >> 7;
		}
		this.bounds.valid = false;
		this.vertexBuffer.valid = false;
	}
	...
	private void method4103() {
		if (tempBuffer.data.length < this.anInt5296 * 12) {
			tempBuffer = new Packet((this.anInt5296 + 100) * 12);
		} else {
			tempBuffer.offset = 0;
		}
		@Pc(25) int local25;
		if (GlRenderer.bigEndian) {
			...
			for (local25 = 0; local25 < this.triangleCount; local25++) {
				tempBuffer.p4le(this.aShortArray77[local25]);
				tempBuffer.p4le(this.aShortArray82[local25]);
				tempBuffer.p4le(this.aShortArray83[local25]);
			}
		}
		...
		@Pc(95) ByteBuffer local95 = ByteBuffer.wrap(tempBuffer.data, 0, tempBuffer.offset);
		vbo.setArrayBuffer(local95);
		this.indexBuffer.valid = true;
	...
	private void method4113(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) boolean arg4) {
		...
		if (tempBuffer.data.length < this.anInt5296 * stride) {
			tempBuffer = new Packet((this.anInt5296 + 100) * stride);
		} else {
			tempBuffer.offset = 0;
		}
		@Pc(60) int local60;
			...
			if (GlRenderer.bigEndian) {
				...
				for (local60 = 0; local60 < this.vertexCount; local60++) {
					...
					for (local99 = local90; local99 < local97; local99++) {
						...
						tempBuffer.offset = local109 * stride;
						tempBuffer.p4le(local71);
						tempBuffer.p4le(local78);
						tempBuffer.p4le(local85);
					}
				}
			}
		}
	...
	public final GlModel method4117(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) boolean arg2, @OriginalArg(4) boolean arg3, @OriginalArg(5) boolean arg4, @OriginalArg(6) boolean arg5, @OriginalArg(7) boolean arg6, @OriginalArg(9) boolean arg7, @OriginalArg(10) boolean arg8) {
		...
		model.anIntArrayArray37 = this.anIntArrayArray37;
	...
	protected final void applyBoneTransformHierarchy(@OriginalArg(0) int transformType, @OriginalArg(1) int[] boneIndices, @OriginalArg(2) int x, @OriginalArg(3) int y, @OriginalArg(4) int z, @OriginalArg(5) boolean updateNormals) {
		...
		if (transformType == 0) {
			...
			anInt5299 = 0;
			for (local26 = 0; local26 < local2; local26++) {
				@Pc(33) int local33 = boneIndices[local26];
				if (local33 < this.boneVertices.length) {
					@Pc(43) int[] local43 = this.boneVertices[local33];
					for (local45 = 0; local45 < local43.length; local45++) {
						local53 = local43[local45];
		...
		if (transformType == 2) {
			for (local18 = 0; local18 < local2; local18++) {
				...
				if (local26 < this.boneVertices.length) {
					...
					for (local143 = 0; local143 < local141.length; local143++) {
						...
						this.vertexZ[local45] -= anInt5299;
						if (z != 0) {
							local53 = MathUtils.sin[z];
							local246 = MathUtils.cos[z];
						...
						if (x != 0) {
							local53 = MathUtils.sin[x];
							local246 = MathUtils.cos[x];
						...
						if (y != 0) {
							local53 = MathUtils.sin[y];
							local246 = MathUtils.cos[y];
			...
			if (updateNormals && this.aShortArray76 != null) {
				for (local18 = 0; local18 < local2; local18++) {
					local26 = boneIndices[local18];
					if (local26 < this.boneVertices.length) {
						local141 = this.boneVertices[local26];
						for (local143 = 0; local143 < local141.length; local143++) {
							...
							for (local264 = local53; local264 < local246; local264++) {
								...
								@Pc(516) int local516;
								if (z != 0) {
									local494 = MathUtils.sin[z];
									local498 = MathUtils.cos[z];
								...
								if (x != 0) {
									local494 = MathUtils.sin[x];
									local498 = MathUtils.cos[x];
								...
								if (y != 0) {
									local494 = MathUtils.sin[y];
									local498 = MathUtils.cos[y];
			...
			for (local18 = 0; local18 < local2; local18++) {
				...
				if (local26 < this.boneVertices.length) {
					...
					for (local143 = 0; local143 < local141.length; local143++) {
						...
						this.vertexY[local45] -= anInt5300;
						this.vertexZ[local45] -= anInt5299;
						this.vertexX[local45] = this.vertexX[local45] * x >> 7;
						this.vertexY[local45] = this.vertexY[local45] * y >> 7;
						this.vertexZ[local45] = this.vertexZ[local45] * z >> 7;
						this.vertexX[local45] += anInt5298;
						this.vertexY[local45] += anInt5300;
						this.vertexZ[local45] += anInt5299;
					}
			...
			if (this.anIntArrayArray37 != null && this.triangleAlpha != null) {
				for (local18 = 0; local18 < local2; local18++) {
					...
					if (local26 < this.anIntArrayArray37.length) {
						...
						for (local143 = 0; local143 < local141.length; local143++) {
							local45 = local141[local143];
							local53 = (this.triangleAlpha[local45] & 0xFF) + x * 8;
							if (local53 < 0) {
								local53 = 0;
							} else if (local53 > 255) {
								local53 = 255;
		...
		} else if (transformType == 7 && this.anIntArrayArray37 != null) {
			for (local18 = 0; local18 < local2; local18++) {
				local26 = boneIndices[local18];
				if (local26 < this.anIntArrayArray37.length) {
					local141 = this.anIntArrayArray37[local26];
					for (local143 = 0; local143 < local141.length; local143++) {
						...
						@Pc(932) int local932 = local246 + x & 0x3F;
						local264 += y / 4;
						if (local264 < 0) {
							local264 = 0;
						} else if (local264 > 7) {
	...
	protected final void applyBoneTransform(@OriginalArg(0) int transformType, @OriginalArg(1) int x, @OriginalArg(2) int y, @OriginalArg(3) int z) {
		...
		if (transformType == 0) {
			...
			if (local3 > 0) {
				anInt5298 = anInt5298 / local3 + x;
				anInt5300 = anInt5300 / local3 + y;
				anInt5299 = anInt5299 / local3 + z;
			} else {
				anInt5298 = x;
				anInt5300 = y;
				anInt5299 = z;
			...
			if (transformType == 2) {
				...
				for (local3 = 0; local3 < this.triangleCount; local3++) {
					...
					@Pc(502) int local502 = local146 + x & 0x3F;
					local164 += y / 4;
					if (local164 < 0) {
						local164 = 0;
					} else if (local164 > 7) {
	...
	private void method4121() {
		...
		for (@Pc(419) int local419 = 0; local419 < local417; local419++) {
			...
			if (this.indexBuffer.vbo == null) {
				...
				gl.glDrawElements(GL2.GL_TRIANGLES, (local434 - local427) * 3, GL2.GL_UNSIGNED_INT, (long) (local427 * 12));
			}
		}
	}
