...
public final class Js5CachedResourceProvider extends Js5ResourceProvider {
	...
	private final IterableHashTable requests = new IterableHashTable(16);
	...
	public void method534() {
		...
		if (!this.discardOrphans || this.orphanCheckTime > SystemTimer.safetime()) {
			return;
		}
		...
		this.orphanCheckTime = SystemTimer.safetime() + 1000L;
	}
