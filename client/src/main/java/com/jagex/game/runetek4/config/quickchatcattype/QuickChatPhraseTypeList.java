package com.jagex.game.runetek4.config.quickchatcattype;

import com.jagex.core.utils.string.JString;
import com.jagex.core.datastruct.key.LruCache;
import com.jagex.ui.chat.QuickChatCommandDecoder;
...
public class QuickChatPhraseTypeList {
    ...
    public static final LruCache types = new LruCache(64);
