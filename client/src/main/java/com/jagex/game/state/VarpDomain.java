...
import com.jagex.types.varp.VarpType;
import com.jagex.types.varbit.VarbitType;
...
public class VarpDomain {
    ...
    public static void resetVarBits() {
        ...
        pendingUpdates = new IterableHashTable(16);
    }
    ...
    public static int poll(@OriginalArg(0) boolean arg0) {
        @Pc(4) long local4 = SystemTimer.safetime();
