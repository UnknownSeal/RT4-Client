...
public final class Component {
	...
	public Sprite method482(@OriginalArg(1) int arg0) {
		...
		local43 = SpriteLoader.loadSprites(local29, InterfaceManager.gameImageJs5);
		if (local43 == null) {
			aBoolean72 = true;
		} else {
	...
	public Model method488(@OriginalArg(0) int arg0, @OriginalArg(1) SeqType arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) boolean arg4, @OriginalArg(6) PlayerAppearance arg5) {
		...
		if (local10 == 0) {
			...
			if (local10 == 1) {
				...
				if (local61 == null) {
					@Pc(69) RawModel local69 = RawModel.create(InterfaceManager.aClass153_85, local13);
					if (local69 == null) {
						aBoolean72 = true;
						return null;
					}
	...
	public Font getFont(@OriginalArg(0) IndexedSprite[] arg0) {
		...
		font = Font.getFont(this.fontId, InterfaceManager.gameImageJs5, InterfaceManager.aClass153_64);
		if (font == null) {
			aBoolean72 = true;
		} else {
