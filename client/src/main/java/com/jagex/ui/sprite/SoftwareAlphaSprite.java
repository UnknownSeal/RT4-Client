...
public final class SoftwareAlphaSprite extends SoftwareSprite {
	...
	@OriginalMember(owner = "runetek4.client!am", name = "b", descriptor = "([I[IIIIIIIIIIII)V")
	...
	@OriginalMember(owner = "runetek4.client!am", name = "c", descriptor = "([I[IIIIIIII)V")
	...
	@OriginalMember(owner = "runetek4.client!am", name = "d", descriptor = "([I[IIIIIIII)V")
	...
	@OriginalMember(owner = "runetek4.client!am", name = "b", descriptor = "([I[IIIIIIIII)V")
	...
	@OriginalMember(owner = "runetek4.client!am", name = "b", descriptor = "([I[IIIIIIIIIII)V")
	...
	@OriginalMember(owner = "runetek4.client!am", name = "a", descriptor = "(IIIIIIDI)V")
	@Override
		...
		try {
			...
			for (@Pc(65) int local65 = 0; local65 < 20; local65++) {
				...
				for (@Pc(77) int local77 = -20; local77 < 0; local77++) {
					...
					@Pc(97) int local97 = SoftwareRenderer.pixels[local70];
					@Pc(101) int local101 = local93 >>> 24;
					@Pc(105) int local105 = 256 - local101;
					SoftwareRenderer.pixels[local70++] = ((local93 & 0xFF00FF) * local101 + (local97 & 0xFF00FF) * local105 & 0xFF00FF00) + ((local93 & 0xFF00) * local101 + (local97 & 0xFF00) * local105 & 0xFF0000) >>> 8;
					local72 += local33;
					local74 -= local27;
				}
				local45 += local27;
	...
	public final void render(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local23 > 0 && local20 > 0) {
			method319(SoftwareRenderer.pixels, this.pixels, local17, local15, local23, local20, local27, local29);
		}
	}
	...
	@OriginalMember(owner = "runetek4.client!am", name = "a", descriptor = "(IIIIII)V")
	@Override
					...
					while (local384 < 0) {
						...
						if (local378 >= 0 && local378 - (this.height << 12) < 0) {
							...
							while (local394 < 0) {
								...
								local436 = SoftwareRenderer.pixels[local388];
								local440 = local432 >>> 24;
								local444 = 256 - local440;
								SoftwareRenderer.pixels[local388++] = ((local432 & 0xFF00FF) * local440 + (local436 & 0xFF00FF) * local444 & 0xFF00FF00) + ((local432 & 0xFF00) * local440 + (local436 & 0xFF00) * local444 & 0xFF0000) >>> 8;
								local802 += local342;
								local394++;
							}
						}
	...
	@OriginalMember(owner = "runetek4.client!am", name = "a", descriptor = "(IIIIIIII[I[I)V")
	@Override
	public final void renderRotated(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9) {
		try {
			...
			for (@Pc(71) int local71 = 0; local71 < arg3; local71++) {
				...
				for (@Pc(99) int local99 = -arg9[local71]; local99 < 0; local99++) {
					...
					@Pc(119) int local119 = SoftwareRenderer.pixels[local82];
					@Pc(123) int local123 = local115 >>> 24;
					@Pc(127) int local127 = 256 - local123;
					SoftwareRenderer.pixels[local82++] = ((local115 & 0xFF00FF) * local123 + (local119 & 0xFF00FF) * local127 & 0xFF00FF00) + ((local115 & 0xFF00) * local123 + (local119 & 0xFF00) * local127 & 0xFF0000) >>> 8;
					local88 += local39;
					local94 -= local33;
				}
				local51 += local33;
	...
	@OriginalMember(owner = "runetek4.client!am", name = "b", descriptor = "(IIIIIIII[I[I)V")
	@Override
	public final void renderRotated(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int[] arg7, @OriginalArg(9) int[] arg8) {
		try {
			@Pc(4) int local4 = -arg2 / 2;
			@Pc(9) int local9 = -arg3 / 2;
			@Pc(18) int local18 = (int) (Math.sin((double) arg6 / 326.11D) * 65536.0D);
	...
	public final void renderAlpha(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		method317(SoftwareRenderer.pixels, this.pixels, local12, local14, local46, local130, arg2, arg3, local26, local32, local7, arg4);
	}
	...
	public final void renderResized(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		method321(SoftwareRenderer.pixels, this.pixels, local12, local14, local46, local130, arg2, arg3, local26, local32, local7);
	}
	...
	public final void renderHorizontalFlip(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local32 > 0 && local29 > 0) {
			method318(SoftwareRenderer.pixels, this.pixels, local26, local21, local32, local29, local36, local40);
		}
	}
	...
	public final void renderAlpha(@OriginalArg(0) int x, @OriginalArg(1) int y, @OriginalArg(2) int alpha) {
		...
		if (local23 > 0 && local20 > 0) {
			method320(SoftwareRenderer.pixels, this.pixels, local17, local15, local23, local20, local27, local29, alpha);
		}
	}
}
