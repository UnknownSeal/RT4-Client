package com.jagex.core.utils.string;

import java.awt.FontMetrics;
import java.awt.Graphics;
import java.io.UnsupportedEncodingException;

import com.jagex.ui.component.ComponentString;
...
public final class JString implements ComponentString {
	...
	public static IterableHashTable aClass133_13;
	...
	public final JString method3151() {
		...
		synchronized (local19) {
			@Pc(30) JstringNode local30;
			if (aClass133_13 == null) {
				aClass133_13 = new IterableHashTable(4096);
			} else {
				for (local30 = (JstringNode) aClass133_13.get(local9); local30 != null; local30 = (JstringNode) aClass133_13.nextWithKey()) {
					if (this.strEquals(local30.value)) {
						return local30.value;
					}
				}
			}
			local30 = new JstringNode();
			local30.value = this;
