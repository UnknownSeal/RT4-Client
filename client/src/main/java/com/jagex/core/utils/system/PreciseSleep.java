package com.jagex.core.utils.system;
...
import com.jagex.graphics.textureops.TextureOp29SubOp4;
import com.jagex.graphics.textureops.TextureOpRasterizer;
...
public final class PreciseSleep {
	...
	public static void method3981(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		if (arg4 >= TextureOpRasterizer.anInt5773 && TextureOpRasterizer.anInt2869 >= arg4) {
			...
			local174 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg5 - arg0, TextureOpRasterizer.anInt4164);
			local183 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg5 + arg0, TextureOpRasterizer.anInt4164);
			local192 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg5 - local12, TextureOpRasterizer.anInt4164);
			local201 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg5 + local12, TextureOpRasterizer.anInt4164);
		...
		while (local16 > 0) {
			...
			if (TextureOpRasterizer.anInt5773 <= local183 && TextureOpRasterizer.anInt2869 >= local174) {
				local192 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg5 + local7, TextureOpRasterizer.anInt4164);
				local201 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg5 - local7, TextureOpRasterizer.anInt4164);
				if (local255) {
					@Pc(404) int local404 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg5 + local14, TextureOpRasterizer.anInt4164);
					@Pc(412) int local412 = IntMath.clamp(FloorUnderlayTypeList.anInt5063, arg5 - local14, TextureOpRasterizer.anInt4164);
					@Pc(420) int[] local420;
	...
	public static void method3982(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		...
		if (local15 == 0) {
			...
			} else if (arg2 > FloorUnderlayTypeList.anInt5063) {
				local76 = (FloorUnderlayTypeList.anInt5063 * local50 >> 12) + local59;
				local68 = FloorUnderlayTypeList.anInt5063;
			} else {
				local68 = arg2;
				local76 = arg3;
			}
			...
			} else if (FloorUnderlayTypeList.anInt5063 < arg4) {
				local109 = FloorUnderlayTypeList.anInt5063;
				local118 = local59 + (local50 * FloorUnderlayTypeList.anInt5063 >> 12);
			} else {
				local118 = arg1;
				local109 = arg4;
			}
