...
public abstract class Entity {
	...
	@OriginalMember(owner = "runetek4.client!th", name = "a", descriptor = "()Z")
	...
	public abstract void update(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);

	@OriginalMember(owner = "runetek4.client!th", name = "a", descriptor = "(IIIIIIIIJILclient!ga;)V")
	...
	@OriginalMember(owner = "runetek4.client!th", name = "b", descriptor = "()I")
