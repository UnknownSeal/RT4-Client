...
public abstract class PathingEntity extends Entity {
	...
	public final void teleport(@OriginalArg(1) int arg0, @OriginalArg(2) int x, @OriginalArg(3) int z, @OriginalArg(4) boolean jump) {
		if (this.primarySeqId != -1 && SeqTypeList.get(this.primarySeqId).movetype == 1) {
			this.primarySeqId = -1;
		}
		if (!jump) {
			@Pc(32) int dx = x - this.movementQueueX[0];
			@Pc(40) int dz = z - this.movementQueueZ[0];
	...
	protected final void method2685(@OriginalArg(1) Model arg0, @OriginalArg(2) int arg1) {
		...
		@Pc(87) int local87 = SceneGraph.getTileHeight(Player.currentLevel, local75 + this.xFine, this.zFine + local64);
		...
		@Pc(134) int local134 = SceneGraph.getTileHeight(Player.currentLevel, local106 + this.xFine, this.zFine - -local121);
		...
		@Pc(201) int local201 = SceneGraph.getTileHeight(Player.currentLevel, this.xFine + local169, local150 + this.zFine);
		@Pc(212) int local212 = local134 > local87 ? local87 : local134;
		@Pc(224) int local224 = SceneGraph.getTileHeight(Player.currentLevel, local189 + this.xFine, local179 + this.zFine);
