...
public final class Static17 {
	...
	@OriginalMember(owner = "runetek4.client!bg", name = "g", descriptor = "Lclient!i;")
	public static final PacketBit aClass3_Sub15_Sub1_2 = new PacketBit(5000);

	@OriginalMember(owner = "runetek4.client!bg", name = "z", descriptor = "Lclient!na;")
	public static final JagString aClass100_101 = Static28.parse("k");

	@OriginalMember(owner = "runetek4.client!bg", name = "A", descriptor = "[I")
	...
	@OriginalMember(owner = "runetek4.client!bg", name = "d", descriptor = "(II)Z")
	public static boolean method530(@OriginalArg(0) int arg0) {
		return arg0 == 198 || arg0 == 230 || arg0 == 156 || arg0 == 140 || arg0 == 223;
	}

	@OriginalMember(owner = "runetek4.client!bg", name = "a", descriptor = "(Lclient!be;ZI)V")
