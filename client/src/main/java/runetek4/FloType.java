...
@OriginalClass("runetek4.client!wl")
public final class FloType {

	@OriginalMember(owner = "runetek4.client!wl", name = "j", descriptor = "Z")
	public boolean aBoolean310 = false;

	@OriginalMember(owner = "runetek4.client!wl", name = "l", descriptor = "Z")
	public boolean aBoolean311 = true;

	@OriginalMember(owner = "runetek4.client!wl", name = "p", descriptor = "I")
	public int anInt5892 = -1;

	@OriginalMember(owner = "runetek4.client!wl", name = "f", descriptor = "I")
	public int anInt5885 = 128;

	@OriginalMember(owner = "runetek4.client!wl", name = "w", descriptor = "I")
	public int anInt5897 = 8;

	@OriginalMember(owner = "runetek4.client!wl", name = "x", descriptor = "I")
	public int anInt5898 = 16;

	@OriginalMember(owner = "runetek4.client!wl", name = "t", descriptor = "I")
	public int anInt5894 = -1;

	@OriginalMember(owner = "runetek4.client!wl", name = "y", descriptor = "Z")
	public boolean aBoolean312 = true;

	@OriginalMember(owner = "runetek4.client!wl", name = "z", descriptor = "I")
	public int anInt5899 = 0;

	@OriginalMember(owner = "runetek4.client!wl", name = "m", descriptor = "I")
	public int anInt5889 = 1190717;

	@OriginalMember(owner = "runetek4.client!wl", name = "a", descriptor = "(ILclient!wa;I)V")
	...
	@OriginalMember(owner = "runetek4.client!wl", name = "a", descriptor = "(IILclient!wa;I)V")
