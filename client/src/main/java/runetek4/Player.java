...
public final class Player extends PathingEntity {
	...
	@OriginalMember(owner = "runetek4.client!e", name = "a", descriptor = "(Lclient!ga;ILclient!ak;IIIIIIIIIIII)V")
	...
	@OriginalMember(owner = "runetek4.client!e", name = "a", descriptor = "(IIIII)V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!e", name = "b", descriptor = "()I")
	@Override
