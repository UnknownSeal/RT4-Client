...
@OriginalClass("runetek4.client!ji")
public final class VorbisCodebook {

	@OriginalMember(owner = "runetek4.client!ji", name = "f", descriptor = "[I")
	private int[] anIntArray288;

	@OriginalMember(owner = "runetek4.client!ji", name = "c", descriptor = "I")
	public final int anInt3055;

	@OriginalMember(owner = "runetek4.client!ji", name = "e", descriptor = "I")
	private final int anInt3056;

	@OriginalMember(owner = "runetek4.client!ji", name = "a", descriptor = "[I")
	private final int[] anIntArray286;

	@OriginalMember(owner = "runetek4.client!ji", name = "d", descriptor = "[I")
	private int[] anIntArray287;

	@OriginalMember(owner = "runetek4.client!ji", name = "b", descriptor = "[[F")
	private float[][] aFloatArrayArray1;

	@OriginalMember(owner = "runetek4.client!ji", name = "<init>", descriptor = "()V")
	...
	@OriginalMember(owner = "runetek4.client!ji", name = "a", descriptor = "()[F")
	public final float[] method2413() {
		return this.aFloatArrayArray1[this.method2415()];
	}

	@OriginalMember(owner = "runetek4.client!ji", name = "b", descriptor = "()V")
