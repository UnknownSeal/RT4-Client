package runetek4.game.config.npctype;
...
public final class NPCType {
	...
	@OriginalMember(owner = "runetek4.client!me", name = "b", descriptor = "[S")
	private short[] retex_d;

	@OriginalMember(owner = "runetek4.client!me", name = "c", descriptor = "[B")
	private byte[] recol_d_palette;

	@OriginalMember(owner = "runetek4.client!me", name = "d", descriptor = "[S")
	private short[] recol_s;

	@OriginalMember(owner = "runetek4.client!me", name = "g", descriptor = "[I")
	private int[] heads;

	@OriginalMember(owner = "runetek4.client!me", name = "o", descriptor = "[S")
	private short[] recol_d;

	@OriginalMember(owner = "runetek4.client!me", name = "t", descriptor = "[[I")
	private int[][] anIntArrayArray28;

	@OriginalMember(owner = "runetek4.client!me", name = "z", descriptor = "[[I")
	private int[][] modeloffset;

	@OriginalMember(owner = "runetek4.client!me", name = "J", descriptor = "[S")
	...
	@OriginalMember(owner = "runetek4.client!me", name = "hb", descriptor = "[I")
	public int[] multinpc;

	@OriginalMember(owner = "runetek4.client!me", name = "A", descriptor = "I")
	public int bgsound = -1;

	@OriginalMember(owner = "runetek4.client!me", name = "I", descriptor = "Z")
	public boolean active = true;

	@OriginalMember(owner = "client!me", name = "a", descriptor = "I")
	public int size = 1;

	@OriginalMember(owner = "runetek4.client!me", name = "q", descriptor = "Z")
	public boolean walksmoothing = true;

	@OriginalMember(owner = "runetek4.client!me", name = "O", descriptor = "I")
	public int bgsound_run = -1;

	@OriginalMember(owner = "runetek4.client!me", name = "r", descriptor = "S")
	...
	@OriginalMember(owner = "runetek4.client!me", name = "Z", descriptor = "Z")
	public boolean minimap = true;

	@OriginalMember(owner = "runetek4.client!me", name = "l", descriptor = "I")
	public int anInt3719 = -1;

	@OriginalMember(owner = "runetek4.client!me", name = "U", descriptor = "I")
	private int contrast = 0;

	@OriginalMember(owner = "runetek4.client!me", name = "V", descriptor = "I")
	public int anInt3739 = -1;

	@OriginalMember(owner = "runetek4.client!me", name = "C", descriptor = "I")
	private int resizeh = 128;

	@OriginalMember(owner = "runetek4.client!me", name = "N", descriptor = "B")
	public byte spotshadowtrans_2 = -16;

	@OriginalMember(owner = "runetek4.client!me", name = "H", descriptor = "I")
	public int anInt3732 = -1;

	@OriginalMember(owner = "runetek4.client!me", name = "F", descriptor = "B")
	public byte walkflags = 0;

	@OriginalMember(owner = "runetek4.client!me", name = "e", descriptor = "Z")
	public boolean spotshadow = true;

	@OriginalMember(owner = "runetek4.client!me", name = "ab", descriptor = "S")
	public short spotshadowcolour_1 = 0;

	@OriginalMember(owner = "runetek4.client!me", name = "db", descriptor = "I")
	public int anInt3743 = -1;

	@OriginalMember(owner = "runetek4.client!me", name = "R", descriptor = "I")
	public int anInt3736 = -1;

	@OriginalMember(owner = "runetek4.client!me", name = "h", descriptor = "I")
	private int ambient = 0;

	@OriginalMember(owner = "runetek4.client!me", name = "B", descriptor = "Z")
	public boolean drawabove = false;

	@OriginalMember(owner = "runetek4.client!me", name = "M", descriptor = "I")
	public int turnspeed = 32;

	@OriginalMember(owner = "client!me", name = "u", descriptor = "[Lclient!na;")
	public final JagString[] ops = new JagString[5];

	@OriginalMember(owner = "runetek4.client!me", name = "ib", descriptor = "I")
	public int bgsound_walk = -1;

	@OriginalMember(owner = "runetek4.client!me", name = "bb", descriptor = "B")
	public byte spotshadowtrans_1 = -96;

	@OriginalMember(owner = "runetek4.client!me", name = "G", descriptor = "B")
	public byte respawndir = 7;

	@OriginalMember(owner = "runetek4.client!me", name = "S", descriptor = "I")
	public int bas = -1;

	@OriginalMember(owner = "runetek4.client!me", name = "mb", descriptor = "I")
	public int anInt3750 = -1;

	@OriginalMember(owner = "runetek4.client!me", name = "gb", descriptor = "I")
	public int bgsound_range = 0;

	@OriginalMember(owner = "runetek4.client!me", name = "E", descriptor = "I")
	private int resizev = 128;

	@OriginalMember(owner = "runetek4.client!me", name = "s", descriptor = "I")
	private int multivarbit = -1;

	@OriginalMember(owner = "runetek4.client!me", name = "fb", descriptor = "I")
	public int bgsound_crawl = -1;

	@OriginalMember(owner = "runetek4.client!me", name = "D", descriptor = "I")
	public int overlayheight = -1;

	@OriginalMember(owner = "runetek4.client!me", name = "Q", descriptor = "I")
	public int anInt3735 = -1;

	@OriginalMember(owner = "runetek4.client!me", name = "lb", descriptor = "I")
	private int multivarp = -1;

	@OriginalMember(owner = "runetek4.client!me", name = "ob", descriptor = "I")
	public int cursorattack = -1;

	@OriginalMember(owner = "runetek4.client!me", name = "a", descriptor = "(B)Lclient!me;")
	public final NPCType method2932() {
		@Pc(5) int local5 = -1;
		if (this.multivarbit != -1) {
			local5 = Static155.method2945(this.multivarbit);
		} else if (this.multivarp != -1) {
			local5 = Static7.anIntArray75[this.multivarp];
		}
		if (local5 < 0 || local5 >= this.multinpc.length - 1 || this.multinpc[local5] == -1) {
			@Pc(55) int local55 = this.multinpc[this.multinpc.length - 1];
			return local55 == -1 ? null : Static214.method4363(local55);
		} else {
			return Static214.method4363(this.multinpc[local5]);
		}
	}

	@OriginalMember(owner = "runetek4.client!me", name = "b", descriptor = "(B)Z")
	...
	@OriginalMember(owner = "runetek4.client!me", name = "a", descriptor = "(I)Z")
	...
	@OriginalMember(owner = "runetek4.client!me", name = "a", descriptor = "(III)I")
	public final int method2936(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		if (this.params == null) {
			return arg1;
		} else {
			@Pc(18) IntWrapper local18 = (IntWrapper) this.params.getNode((long) arg0);
			return local18 == null ? arg1 : local18.value;
		}
	}

	@OriginalMember(owner = "runetek4.client!me", name = "a", descriptor = "([Lclient!ub;IBIIIILclient!tk;ILclient!tk;)Lclient!ak;")
	public final Model method2937(@OriginalArg(0) Class147[] arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) SeqType arg6, @OriginalArg(8) int arg7, @OriginalArg(9) SeqType arg8) {
		...
		if (!local46 && arg8 == null && arg6 == null) {
			...
			if (this.resizeh != 128 || this.resizev != 128) {
				local933.method4559(this.resizeh, this.resizev, this.resizeh);
			}
			return local933;
		}
		local221 = -1;
		...
		if (this.resizeh != 128 || this.resizev != 128) {
			local1218.method4559(this.resizeh, this.resizev, this.resizeh);
		}
		return local1218;
	}
	...
	public JagString getParam(@OriginalArg(0) int arg0, @OriginalArg(1) JagString arg1) {
		if (this.params == null) {
			...
			@Pc(18) JagStringWrapper local18 = (JagStringWrapper) this.params.getNode((long) arg0);
			return local18 == null ? arg1 : local18.value;
		}
	}
	...
	@OriginalMember(owner = "runetek4.client!me", name = "b", descriptor = "(I)V")
	public final void method2942() {
	}

	@OriginalMember(owner = "runetek4.client!me", name = "a", descriptor = "(Lclient!tk;IIII)Lclient!ak;")
	...
	@OriginalMember(owner = "runetek4.client!me", name = "a", descriptor = "(IILclient!wa;)V")
	private void decode(@OriginalArg(1) int code, @OriginalArg(2) Packet packet) {
		...
		if (code == 1) {
			...
			for (int index = 0; index < local12; index++) {
				...
				this.params.pushNode(node, (long) local596);
			}
		}
	}
}
