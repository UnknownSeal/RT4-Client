...
public final class SoundBank {
	...
	private final IterableMap aClass133_11 = new IterableMap(256);
	...
	private PcmSound method2737(@OriginalArg(0) int[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		...
		@Pc(37) PcmSound local37 = (PcmSound) this.aClass133_12.getNode(local30);
		if (local37 != null) {
			return local37;
	...
	private PcmSound method2740(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(33) PcmSound local33 = (PcmSound) this.aClass133_12.getNode(local26);
		if (local33 != null) {
			return local33;
		} else if (arg1 == null || arg1[0] > 0) {
			@Pc(53) VorbisSound local53 = (VorbisSound) this.aClass133_11.getNode(local26);
			if (local53 == null) {
