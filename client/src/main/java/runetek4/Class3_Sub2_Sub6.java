...
public final class Class3_Sub2_Sub6 extends SecondaryNode {
	...
	@OriginalMember(owner = "runetek4.client!cb", name = "L", descriptor = "[I")
	private int[] anIntArray71;

	@OriginalMember(owner = "runetek4.client!cb", name = "M", descriptor = "[I")
	public int[] anIntArray72;

	@OriginalMember(owner = "runetek4.client!cb", name = "U", descriptor = "[[I")
	private int[][] anIntArrayArray5;

	@OriginalMember(owner = "runetek4.client!cb", name = "V", descriptor = "[Lclient!na;")
	private JagString[] aClass100Array35;

	@OriginalMember(owner = "runetek4.client!cb", name = "O", descriptor = "Z")
	...
	@OriginalMember(owner = "runetek4.client!cb", name = "e", descriptor = "(I)V")
	...
	@OriginalMember(owner = "runetek4.client!cb", name = "a", descriptor = "(III)I")
	...
	@OriginalMember(owner = "runetek4.client!cb", name = "c", descriptor = "(II)I")
	...
	@OriginalMember(owner = "runetek4.client!cb", name = "a", descriptor = "(Z)I")
	...
	@OriginalMember(owner = "runetek4.client!cb", name = "f", descriptor = "(I)Lclient!na;")
