...
@OriginalClass("runetek4.client!aa")
public final class Class2 {

	@OriginalMember(owner = "runetek4.client!aa", name = "f", descriptor = "I")
	public int anInt11;

	@OriginalMember(owner = "runetek4.client!aa", name = "i", descriptor = "I")
	public int anInt12;

	@OriginalMember(owner = "runetek4.client!aa", name = "s", descriptor = "Z")
	public boolean aBoolean2 = false;

	@OriginalMember(owner = "runetek4.client!aa", name = "a", descriptor = "(BLclient!wa;I)V")
	...
	@OriginalMember(owner = "runetek4.client!aa", name = "a", descriptor = "(IB)Lclient!ek;")
	...
	@OriginalMember(owner = "runetek4.client!aa", name = "a", descriptor = "(ILclient!wa;II)V")
