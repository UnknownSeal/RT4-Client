...
@OriginalClass("runetek4.client!el")
public final class GlAlphaSprite extends GlSprite {

	@OriginalMember(owner = "runetek4.client!el", name = "<init>", descriptor = "(IIIIII[I)V")
	...
	@OriginalMember(owner = "runetek4.client!el", name = "<init>", descriptor = "(Lclient!mm;)V")
