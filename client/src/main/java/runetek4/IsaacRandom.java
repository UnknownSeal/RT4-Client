...
@OriginalClass("runetek4.client!ij")
public final class IsaacRandom {

	@OriginalMember(owner = "runetek4.client!ij", name = "b", descriptor = "I")
	private int anInt2912;

	@OriginalMember(owner = "runetek4.client!ij", name = "d", descriptor = "I")
	private int anInt2914;

	@OriginalMember(owner = "runetek4.client!ij", name = "f", descriptor = "I")
	private int anInt2916;

	@OriginalMember(owner = "runetek4.client!ij", name = "i", descriptor = "[I")
	private final int[] anIntArray274 = new int[256];

	@OriginalMember(owner = "runetek4.client!ij", name = "k", descriptor = "[I")
	private final int[] anIntArray275 = new int[256];

	@OriginalMember(owner = "runetek4.client!ij", name = "l", descriptor = "I")
	private int anInt2920;

	@OriginalMember(owner = "runetek4.client!ij", name = "<init>", descriptor = "([I)V")
	...
	@OriginalMember(owner = "runetek4.client!ij", name = "a", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "runetek4.client!ij", name = "a", descriptor = "(I)I")
	...
	@OriginalMember(owner = "runetek4.client!ij", name = "b", descriptor = "(I)V")
