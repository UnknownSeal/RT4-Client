...
public abstract class TextureOp extends Node {
	...
	@OriginalMember(owner = "runetek4.client!j", name = "t", descriptor = "Lclient!nd;")
	protected MonochromeImageCache aClass103_41;

	@OriginalMember(owner = "runetek4.client!j", name = "G", descriptor = "I")
	public int anInt5840;

	@OriginalMember(owner = "runetek4.client!j", name = "H", descriptor = "Lclient!pf;")
	protected ColorImageCache aClass121_41;

	@OriginalMember(owner = "runetek4.client!j", name = "u", descriptor = "[Lclient!j;")
	public final TextureOp[] aClass3_Sub1Array42;

	@OriginalMember(owner = "runetek4.client!j", name = "p", descriptor = "Z")
	public boolean aBoolean309;

	@OriginalMember(owner = "runetek4.client!j", name = "<init>", descriptor = "(IZ)V")
	...
	@OriginalMember(owner = "runetek4.client!j", name = "a", descriptor = "(III)[I")
	...
	@OriginalMember(owner = "runetek4.client!j", name = "a", descriptor = "(IB)[I")
	public int[] method4626(@OriginalArg(0) int arg0) {
		throw new IllegalStateException("This operation does not have a monochrome output");
	}

	@OriginalMember(owner = "runetek4.client!j", name = "d", descriptor = "(B)I")
	...
	@OriginalMember(owner = "runetek4.client!j", name = "b", descriptor = "(III)V")
	...
	@OriginalMember(owner = "runetek4.client!j", name = "e", descriptor = "(B)V")
	...
	@OriginalMember(owner = "runetek4.client!j", name = "a", descriptor = "(IIB)[[I")
	...
	@OriginalMember(owner = "runetek4.client!j", name = "b", descriptor = "(II)[[I")
