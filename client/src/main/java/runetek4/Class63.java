...
@OriginalClass("runetek4.client!ia")
public final class Class63 {

	@OriginalMember(owner = "runetek4.client!ia", name = "a", descriptor = "I")
	public int anInt2850;

	@OriginalMember(owner = "runetek4.client!ia", name = "c", descriptor = "I")
	public int anInt2852;

	@OriginalMember(owner = "runetek4.client!ia", name = "i", descriptor = "I")
	private int anInt2857;

	@OriginalMember(owner = "runetek4.client!ia", name = "a", descriptor = "(B)Lclient!mm;")
	...
	@OriginalMember(owner = "runetek4.client!ia", name = "a", descriptor = "(Lclient!wa;IB)V")
	...
	@OriginalMember(owner = "runetek4.client!ia", name = "a", descriptor = "(IIILclient!wa;)V")
