...
@OriginalClass("runetek4.client!ob")
public final class WaterfallMaterialRenderer implements MaterialRenderer {

	@OriginalMember(owner = "runetek4.client!ob", name = "g", descriptor = "I")
	private int anInt4236;

	@OriginalMember(owner = "runetek4.client!ob", name = "n", descriptor = "[F")
	private final float[] aFloatArray21 = new float[4];

	@OriginalMember(owner = "runetek4.client!ob", name = "<init>", descriptor = "()V")
	public WaterfallMaterialRenderer() {
		this.method3307();
	}

	@OriginalMember(owner = "runetek4.client!ob", name = "c", descriptor = "()I")
	@Override
	public final int method4605() {
		return 0;
	}

	@OriginalMember(owner = "runetek4.client!ob", name = "a", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!ob", name = "a", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!ob", name = "b", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!ob", name = "b", descriptor = "(I)V")
