...
public final class Static25 {
	...
	@OriginalMember(owner = "runetek4.client!c", name = "bb", descriptor = "[Lclient!ec;")
	public static Scenery[] aClass31Array2;

	@OriginalMember(owner = "runetek4.client!c", name = "Y", descriptor = "Lclient!na;")
	public static final JagString aClass100_154 = Static28.parse("Mem:");

	@OriginalMember(owner = "runetek4.client!c", name = "eb", descriptor = "I")
	public static int y = 0;

	@OriginalMember(owner = "runetek4.client!c", name = "hb", descriptor = "Z")
	public static boolean aBoolean57 = false;

	@OriginalMember(owner = "runetek4.client!c", name = "d", descriptor = "(I)Z")
	...
	@OriginalMember(owner = "runetek4.client!c", name = "a", descriptor = "(Ljava/awt/Frame;ZLsignlink!ll;)V")
	...
	@OriginalMember(owner = "runetek4.client!c", name = "c", descriptor = "(II)V")
	public static void method715() {
		Static220.aClass99_28.method3102(5);
	}

	@OriginalMember(owner = "runetek4.client!c", name = "d", descriptor = "(II)V")
