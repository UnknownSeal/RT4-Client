...
public final class Static6 {
	...
	@OriginalMember(owner = "runetek4.client!ag", name = "bb", descriptor = "Lclient!na;")
	public static final JagString aClass100_18 = Static28.parse("<col=40ff00>");

	@OriginalMember(owner = "runetek4.client!ag", name = "cb", descriptor = "[Lclient!cl;")
	public static final AnimFrameset[] aClass3_Sub2_Sub7Array1 = new AnimFrameset[14];

	@OriginalMember(owner = "runetek4.client!ag", name = "h", descriptor = "(I)V")
	...
	@OriginalMember(owner = "runetek4.client!ag", name = "j", descriptor = "(I)V")
	...
	@OriginalMember(owner = "runetek4.client!ag", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/Class;")
	...
	@OriginalMember(owner = "runetek4.client!ag", name = "a", descriptor = "(IIIIIIIII)V")
