...
@OriginalClass("runetek4.client!ge")
public final class Cache {

	@OriginalMember(owner = "runetek4.client!ge", name = "a", descriptor = "Lclient!en;")
	private BufferedFile aClass38_1 = null;

	@OriginalMember(owner = "runetek4.client!ge", name = "f", descriptor = "Lclient!en;")
	private BufferedFile aClass38_2 = null;

	@OriginalMember(owner = "runetek4.client!ge", name = "l", descriptor = "I")
	private int anInt2156 = 65000;

	@OriginalMember(owner = "runetek4.client!ge", name = "c", descriptor = "I")
	private final int anInt2150;

	@OriginalMember(owner = "runetek4.client!ge", name = "<init>", descriptor = "(ILclient!en;Lclient!en;I)V")
	...
	@OriginalMember(owner = "runetek4.client!ge", name = "toString", descriptor = "()Ljava/lang/String;")
	@Override
	public final String toString() {
		return "Cache:" + this.anInt2150;
	}

	@OriginalMember(owner = "runetek4.client!ge", name = "a", descriptor = "(II[BB)Z")
	...
	@OriginalMember(owner = "runetek4.client!ge", name = "a", descriptor = "(IB)[B")
	...
	@OriginalMember(owner = "runetek4.client!ge", name = "a", descriptor = "(BII[BZ)Z")
