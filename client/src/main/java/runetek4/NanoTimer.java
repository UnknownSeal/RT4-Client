...
@OriginalClass("runetek4.client!om")
public final class NanoTimer extends Timer {

	@OriginalMember(owner = "runetek4.client!om", name = "k", descriptor = "J")
	private long aLong142 = System.nanoTime();

	@OriginalMember(owner = "runetek4.client!om", name = "b", descriptor = "(I)V")
	@Override
	public final void method3394() {
		this.aLong142 = System.nanoTime();
	}

	@OriginalMember(owner = "runetek4.client!om", name = "a", descriptor = "(III)I")
	@Override
