...
public final class Static44 {
	...
	public static ReferenceNodeFactory method1147() {
		try {
			return (ReferenceNodeFactory) Class.forName("runetek4.SoftReferenceNodeFactory").getDeclaredConstructor().newInstance();
	...
	public static MouseWheel create() {
		try {
			return (MouseWheel) Class.forName("runetek4.JavaMouseWheel").getDeclaredConstructor().newInstance();
		} catch (@Pc(15) Throwable local15) {
			return null;
		}
	}
