...
@OriginalClass("runetek4.client!dm")
public final class IdkType {

	@OriginalMember(owner = "runetek4.client!dm", name = "b", descriptor = "[S")
	private short[] aShortArray11;

	@OriginalMember(owner = "runetek4.client!dm", name = "i", descriptor = "[S")
	private short[] aShortArray12;

	@OriginalMember(owner = "runetek4.client!dm", name = "s", descriptor = "[S")
	private short[] aShortArray13;

	@OriginalMember(owner = "runetek4.client!dm", name = "t", descriptor = "[S")
	private short[] aShortArray14;

	@OriginalMember(owner = "runetek4.client!dm", name = "w", descriptor = "[I")
	private int[] anIntArray112;

	@OriginalMember(owner = "runetek4.client!dm", name = "x", descriptor = "[I")
	private final int[] anIntArray113 = new int[] { -1, -1, -1, -1, -1 };

	@OriginalMember(owner = "runetek4.client!dm", name = "k", descriptor = "I")
	public int anInt1457 = -1;

	@OriginalMember(owner = "runetek4.client!dm", name = "A", descriptor = "Z")
	public boolean aBoolean85 = false;

	@OriginalMember(owner = "runetek4.client!dm", name = "a", descriptor = "(Z)Lclient!gb;")
	...
	@OriginalMember(owner = "runetek4.client!dm", name = "a", descriptor = "(I)Z")
	...
	@OriginalMember(owner = "runetek4.client!dm", name = "a", descriptor = "(BLclient!wa;I)V")
	...
	@OriginalMember(owner = "runetek4.client!dm", name = "b", descriptor = "(B)Lclient!gb;")
	...
	@OriginalMember(owner = "runetek4.client!dm", name = "c", descriptor = "(I)Z")
	...
	@OriginalMember(owner = "runetek4.client!dm", name = "a", descriptor = "(ILclient!wa;)V")
