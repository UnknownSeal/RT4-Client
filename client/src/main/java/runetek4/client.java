...
public final class client extends GameShell {
	...
	@OriginalMember(owner = "runetek4.client!runetek4.client", name = "main", descriptor = "([Ljava/lang/String;)V")
	public static void main(@OriginalArg(0) String[] arg0) {
		try {
			if (arg0.length != 4) {
				...
				arg0[2] = "english";
				arg0[3] = "game0";
				// runetek4.Static131.method2577("argument count");
			}
			@Pc(15) int local15 = -1;
	...
	@OriginalMember(owner = "runetek4.client!runetek4.client", name = "f", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!runetek4.client", name = "c", descriptor = "(B)V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!runetek4.client", name = "init", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!runetek4.client", name = "g", descriptor = "(I)V")
	@Override
