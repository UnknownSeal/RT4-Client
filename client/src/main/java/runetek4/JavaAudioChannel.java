...
@OriginalClass("runetek4.client!qa")
public final class JavaAudioChannel extends AudioChannel {

	@OriginalMember(owner = "runetek4.client!qa", name = "L", descriptor = "I")
	private int anInt4645;

	@OriginalMember(owner = "runetek4.client!qa", name = "M", descriptor = "Ljavax/sound/sampled/SourceDataLine;")
	private SourceDataLine aSourceDataLine1;

	@OriginalMember(owner = "runetek4.client!qa", name = "O", descriptor = "Ljavax/sound/sampled/AudioFormat;")
	private AudioFormat anAudioFormat1;

	@OriginalMember(owner = "runetek4.client!qa", name = "P", descriptor = "[B")
	private byte[] aByteArray64;

	@OriginalMember(owner = "runetek4.client!qa", name = "N", descriptor = "Z")
	private boolean aBoolean230 = false;

	@OriginalMember(owner = "runetek4.client!qa", name = "d", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!qa", name = "a", descriptor = "(I)V")
	@Override
	public final void method3562(@OriginalArg(0) int arg0) throws LineUnavailableException {
		try {
			...
			if (Static248.method3289(arg0) == 1) {
				...
				this.method3562(Static165.bitceil(arg0));
			}
		}
	}

	@OriginalMember(owner = "runetek4.client!qa", name = "b", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "runetek4.client!qa", name = "c", descriptor = "()I")
	@Override
	protected final int method3569() {
		return this.anInt4645 - (this.aSourceDataLine1.available() >> (Static164.aBoolean192 ? 2 : 1));
	}

	@OriginalMember(owner = "runetek4.client!qa", name = "a", descriptor = "()V")
	@Override
