...
public final class FluType {
	...
	@OriginalMember(owner = "runetek4.client!ni", name = "d", descriptor = "I")
	public int anInt4149;

	@OriginalMember(owner = "runetek4.client!ni", name = "i", descriptor = "I")
	public int anInt4154;

	@OriginalMember(owner = "runetek4.client!ni", name = "r", descriptor = "I")
	public int anInt4158;

	@OriginalMember(owner = "runetek4.client!ni", name = "u", descriptor = "I")
	public int anInt4161;

	@OriginalMember(owner = "runetek4.client!ni", name = "b", descriptor = "I")
	private int anInt4147 = 0;

	@OriginalMember(owner = "runetek4.client!ni", name = "m", descriptor = "I")
	public int anInt4155 = -1;

	@OriginalMember(owner = "runetek4.client!ni", name = "o", descriptor = "I")
	public int anInt4156 = 128;

	@OriginalMember(owner = "runetek4.client!ni", name = "l", descriptor = "Z")
	public boolean aBoolean198 = true;

	@OriginalMember(owner = "runetek4.client!ni", name = "a", descriptor = "(IB)V")
